...
- **data_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin used for DATA.
- **clock_pin** (**Required**, [Pin Schema](#config-pin_schema)): The pin which CLK is
   connected to.

- **id** (*Optional*, [ID](#config-id)): The id to use for
...
- **bp1658cj_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
