...
The MCP2515 communicates with ESPHome via the [SPI bus](#spi); to use it, you must have at least one
[SPI bus](#spi) with both the `mosi_pin` and `miso_pin` defined in your ESPHome configuration.
