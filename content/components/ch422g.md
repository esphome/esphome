...
It uses an [I²C Bus](#i2c) for communication. The I²C address is not configurable as the CH422G has a separate address for each internal register.
...
- **id** (**Required**, [ID](#config-id)): The id to use for this `ch422g` component.

## Pin configuration variables

- **ch422g** (**Required**, [ID](#config-id)): The id of the `ch422g` component of the pin.
