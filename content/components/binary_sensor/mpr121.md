...
[Adafruit](https://learn.adafruit.com/adafruit-mpr121-12-key-capacitive-touch-sensor-breakout-tutorial/overview)) Capacitive Touch Sensor with ESPHome. The [I²C](#i2c) is
...
- **mpr121_id** (*Optional*, [ID](#config-id)): The ID of the MPR121 defined above. Useful for multiple MPR121's on the I²C bus
