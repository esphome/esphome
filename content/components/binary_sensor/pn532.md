...
using [`homeassistant.tag_scanned` Action](#api-homeassistant_tag_scanned_action).
...
App and send it to Home Assistant using the [`homeassistant.tag_scanned` Action](#api-homeassistant_tag_scanned_action). The `tag` variable is
