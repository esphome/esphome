...
[Adafruit](https://learn.adafruit.com/adafruit-cap1188-breakout/overview)) Capacitive Touch Sensor with ESPHome. The [I²C](#i2c) bus is
...
- **id** (*Optional*, [ID](#config-id)): Set the ID of this sensor.
- **reset_pin** (*Optional*, [Pin](#config-pin)): Set the pin that is used to reset the CAP1188 board on boot.
...
- **cap1188_id** (*Optional*, [ID](#config-id)): The ID of the CAP1188 defined above. Useful for multiple CAP1188's on the I²C bus.
