...
[SparkFun](https://learn.sparkfun.com/tutorials/sx1509-io-expander-breakout-hookup-guide/all)) in ESPHome. It uses [I²C Bus](#i2c) for communication.
...
Any option accepting a [Pin Schema](#config-pin_schema) can theoretically be used, but some more
...
- **id** (**Required**, [ID](#config-id)): The id to use for this SX1509 component.
...
- **sx1509** (**Required**, [ID](#config-id)): The id of the SX1509 component of the pin.
