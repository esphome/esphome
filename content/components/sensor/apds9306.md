...
- **update_interval** (*Optional*, [Time](#config-time)): The interval at which the sensor reading will be updated. Defaults to `60s`.
- All opther options from [Sensor](#config-sensor).
