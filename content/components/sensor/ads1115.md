...
To use this hub, first setup the [I²C Bus](#i2c) and connect the sensor to the pins specified there.
...
- **id** (*Optional*, [ID](#config-id)): Manually specify the ID for this ADS1115 Hub. Use this if you
...
- **ads1115_id** (*Optional*, [ID](#config-id)): Manually specify the ID of the
