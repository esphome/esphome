...
[Adafruit](https://www.adafruit.com/product/4022)) three axis magnetometer with ESPHome. The [I²C](#i2c) is required to be set up in
...
- **drdy_pin** (*Optional*, [Pin Schema](#config-pin_schema)): Data-ready pin. Often labelled `INT`. Using this pin might lead to slightly quicker read times.
