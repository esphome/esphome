...
It uses [I²C Bus](#i2c) for communication.
...
- **id** (**Required**, [ID](#config-id)): The id to use for this `pca6416a` component.
- **address** (*Optional*, int): The I²C address of the driver.
  Defaults to `0x20`.

## Pin configuration variables

- **pca6416a** (**Required**, [ID](#config-id)): The id of the `pca6416a` component of the pin.
