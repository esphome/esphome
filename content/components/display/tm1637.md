...
- **lambda** (*Optional*, [lambda](#config-lambda)): The lambda to use for rendering the content on the TM1637.
...
The TM1637 has a similar API to the fully fledged [Display Rendering Engine](#display-engine), but it's only a subset as the TM1637
...
not all characters can be represented. You can see a full list of characters [at the MAX7219 docs](#display-max7219_characters).
