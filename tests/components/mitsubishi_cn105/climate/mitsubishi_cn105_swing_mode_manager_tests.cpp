...
TEST(SwingModeManagerTests, StatusMapsVerticalSwingWhenSupported) {
  ...
  EXPECT_EQ(manager.swing_mode_from(MitsubishiCN105::VaneMode::SWING, MitsubishiCN105::WideVaneMode::CENTER),
...
TEST(SwingModeManagerTests, StatusMapsHorizontalSwingWhenSupported) {
  ...
  EXPECT_EQ(manager.swing_mode_from(MitsubishiCN105::VaneMode::AUTO, MitsubishiCN105::WideVaneMode::SWING),
...
TEST(SwingModeManagerTests, StatusMapsBothSwingWhenSupported) {
  ...
  EXPECT_EQ(manager.swing_mode_from(MitsubishiCN105::VaneMode::SWING, MitsubishiCN105::WideVaneMode::SWING),
...
TEST(SwingModeManagerTests, StatusMapsSwingOffWhenNoSwingActive) {
  auto manager = make_swing_mode_manager({climate::CLIMATE_SWING_OFF, climate::CLIMATE_SWING_VERTICAL,
                                          climate::CLIMATE_SWING_HORIZONTAL, climate::CLIMATE_SWING_BOTH});
  EXPECT_EQ(manager.swing_mode_from(MitsubishiCN105::VaneMode::POSITION_3, MitsubishiCN105::WideVaneMode::CENTER),
...
TEST(SwingModeManagerTests, SwingModeFromReturnsNulloptWhenNoSwingModesSupported) {
  ...
  EXPECT_FALSE(
      manager.swing_mode_from(MitsubishiCN105::VaneMode::SWING, MitsubishiCN105::WideVaneMode::SWING).has_value());
}
