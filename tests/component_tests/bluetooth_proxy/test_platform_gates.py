...
def _set_rp2_with_tracker() -> None:
    # The rp2 arm's ble_hub_id guard needs a loaded tracker, normally
    # registered as an import side effect of the tracker module.
    _set_platform("rp2")
