...
field extractor. This test is what catches that. The outer schema deliberately carries no
upper bound on connection_slots (per-platform schemas enforce their own
caps); the esp32 cap itself is pinned by test_idf_max_connections_mirror.
"""
