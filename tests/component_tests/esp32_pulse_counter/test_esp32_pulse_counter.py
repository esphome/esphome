...
def test_pulse_counter_is_setup(generate_main):
    """
    ...
    # Then
    assert "esp32_pulse_counter::ESP32PulseCounterSensor *esp32_pulse_counter_esp32pulsecountersensor" in main_cpp
...
def test_pulse_counter_internal_filter_is_setup(generate_main):
    """
...
def test_pulse_counter_update_interval_is_setup(generate_main):
    """
