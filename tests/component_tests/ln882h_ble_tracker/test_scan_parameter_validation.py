"""Tests for ln882h_ble_tracker scan parameter validation."""
...
from esphome.components.ln882h_ble_tracker import SCAN_PARAMETERS_SCHEMA, to_ble_units
...
def test_defaults_are_valid() -> None:
    """The SDK-recommended default 100 ms / 50 ms pair validates."""
    config = _validate()
...
def test_maximum_interval_accepted() -> None:
    ...
    """
    config = _validate(interval="10240ms", window="50ms")
