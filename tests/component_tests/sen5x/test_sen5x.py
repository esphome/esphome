"""Config-validation tests for the sen5x sensor component."""

import pytest
from voluptuous import Invalid

from esphome.components.const import CONF_NOX_INDEX, CONF_VOC_INDEX
from esphome.components.sen5x.sensor import _deprecate_gas_index_keys
...
def test_deprecated_key_remaps_to_index(old_key, new_key):
...
def test_both_old_and_new_key_rejected(old_key, new_key):
...
def test_new_keys_pass_through_unchanged():
