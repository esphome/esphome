...
> [status_led light platform](/components/light/status_led/) instead.
...
- [Status LED Light](/components/light/status_led/)
- <APIRef text="status_led.h" path="status_led/status_led.h" />
