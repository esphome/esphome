...
- [Text Text Sensor](/components/text_sensor/text/)
- <APIClass text="Text" path="text::Text" />
- <APIClass text="TextCall" path="text::TextCall" />
