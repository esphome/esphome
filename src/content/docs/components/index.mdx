...
<ImgTable items={[
  ...
  ["Ethernet", "/components/ethernet/", "ethernet.svg", "dark-invert"],
...
<ImgTable items={[
  ...
  ["Motion (IMU)", "/components/sensor/motion/", "imu.svg", "dark-invert"],
...
<ImgTable items={[
  ...
  ["Pixoo Brightness", "/components/light/pixoo/", "brightness-medium.svg", "dark-invert"],
