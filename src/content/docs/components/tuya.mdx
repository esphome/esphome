...
<Image src="/images/tuya.png" width={300} height={158} layout="constrained" alt="" />
...
- *any*: `x` is <APIStruct text="tuya::TuyaDatapoint" path="tuya::TuyaDatapoint" />
...
- <APIRef text="tuya.h" path="tuya/tuya.h" />
