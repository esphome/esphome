...
import tm1651BatteryDisplayImg from './images/tm1651-battery-display.jpg';
...
<Image src={tm1651BatteryDisplayImg} layout="constrained" alt="" />
...
<span id="tm1651-set_level_percent_action"></span>
