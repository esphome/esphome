...
<Figure
  src="/images/seeed_mr60fda2.jpg"
  alt=""
  caption="Seeed Studio MR60FDA2 60GHz mmWave Fall Detection Sensor Kit with XIAO ESP32C6"
  layout="constrained"
  width={300}
  height={300}
/>
...
- **id** (*Optional*, [ID](/guides/configuration-types#id)): Manually specify the ID for this [Seeed Mr60Fda2](/components/seeed_mr60fda2/) component if you need multiple components.
...
- <APIRef text="seeed_mr60fda2.h" path="seeed_mr60fda2/seeed_mr60fda2.h" />
