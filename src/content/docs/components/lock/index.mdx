...
<span id="lock-unlock_action"></span>
...
<span id="lock-is_locked_condition"></span>
<span id="lock-is_unlocked_condition"></span>
...
<span id="lock-on_lock_unlock_trigger"></span>
...
- <APIRef text="lock.h" path="lock/lock.h" />
