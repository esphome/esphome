...
See <APIClass text="output::BinaryOutput" path="output::BinaryOutput" /> and <APIClass text="output::FloatOutput" path="output::FloatOutput" />.
...
<span id="output-template-on_write_action"></span>
