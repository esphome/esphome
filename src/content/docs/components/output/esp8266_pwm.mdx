...
like the one on the ESP32 (see [Ledc](/components/output/ledc/)) are preferred.
...
<span id="output-esp8266_pwm-set_frequency_action"></span>
...
- <APIRef text="esp8266_pwm.h" path="esp8266_pwm/esp8266_pwm.h" />
