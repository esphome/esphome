...
<span id="deep_sleep-esp32_wakeup_pin_mode"></span>
...
<span id="deep_sleep-prevent_action"></span>
...
<span id="deep_sleep-allow_action"></span>
...
- <APIRef text="deep_sleep_component.h" path="deep_sleep/deep_sleep_component.h" />
