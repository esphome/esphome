...
- **microphone** (**Required**, [Microphone Source Configuration](/components/microphone#config-microphone-source)): The [microphone](/components/microphone/) settings to use for audio input.
...
- <APIRef text="micro_wake_word.h" path="micro_wake_word/micro_wake_word.h" />
