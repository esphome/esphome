...
states and allow **control** via your Home Assistant instance using the [native API](/components/api/).
...
- <APIRef text="homeassistant_switch.h" path="homeassistant/switch/homeassistant_switch.h" />
