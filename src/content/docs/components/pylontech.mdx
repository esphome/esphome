...
import rj45PinoutImg from './images/rj45_pinout.jpg';
...
<Figure
  src="/images/pylontech.jpg"
  alt=""
  caption="Pylontech Batteries"
  layout="constrained"
  width={300}
  height={184}
/>
...
By combining [template sensors](/components/sensor/template/) and
[integration sensors](/components/sensor/integration/)
