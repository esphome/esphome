...
import sonoffD1Gpio0Img from './images/sonoff_d1_gpio0.jpg';
import sonoffD1SerialImg from './images/sonoff_d1_serial.jpg';
...
<Figure
  src="/images/sonoff_d1.jpg"
  alt=""
  caption="Sonoff D1 dimmer front and back view. Image by [ITEAD](https://itead.cc/product/sonoff-d1-smart-dimmer-switch/)."
  layout="constrained"
  width={300}
  height={300}
/>
...
<Figure
  src={sonoffD1Gpio0Img}
  alt=""
  caption="Photo of GPIO 0, images by [klotzma](https://github.com/arendst/Tasmota/issues/7598#issuecomment-578433417)."
  layout="constrained"
/>

<Figure
  src={sonoffD1SerialImg}
  alt=""
  caption="Photo of serial port pins, images by [klotzma](https://github.com/arendst/Tasmota/issues/7598#issuecomment-578433417)."
  layout="constrained"
/>
...
- [logger](/components/logger/) to the serial port is disabled by setting `baud_rate` to `0`
- in case you need light state restoration on power up, make sure `restore_from_flash` is set to `true` in the [ESP8266 platform](/components/esp8266/)
