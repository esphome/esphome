...
A detailed analysis of the Shelly Dimmer 2 hardware is given on [arendst/Tasmota#6914](https://github.com/arendst/Tasmota/issues/6914).
...
<Image src="/images/shellydimmer2.jpg" width={300} height={300} layout="constrained" alt="" />
...
- <APIRef text="shelly_dimmer.h" path="shelly_dimmer/light/shelly_dimmer.h" />
