...
- **mode** (*Optional*, enum): Defines the navigation logic. Defaults to `rotary`.
  ...
  - `rotary`  : Rotary mode expects the clockwise movement wired to [display_menu.down](#display_menu-down-action),

      the anticlockwise one to [display_menu.up](#display_menu-up-action) and the switch
      to [display_menu.enter](#display_menu-enter-action) action.

  - `joystick`  : Joystick mode expects the up, down, left and right buttons wired to the [display_menu.up](#display_menu-up-action),

      [display_menu.down](#display_menu-down-action), [display_menu.left](#display_menu-left-action)
      and [display_menu.right](#display_menu-right-action) actions and the middle button
      to the [display_menu.enter](#display_menu-enter-action) action.
...
<span id="display_menu-edit_mode"></span>
...
<span id="display_menu-on_enter"></span>
...
<span id="display_menu-on_leave"></span>
...
<span id="display_menu-on_value"></span>
...
<span id="display_menu-on_next"></span>
...
<span id="display_menu-on_prev"></span>
...
<span id="display_menu-is_active"></span>
...
- <APIRef text="display_menu_base.h" path="display_menu_base/display_menu_base.h" />
