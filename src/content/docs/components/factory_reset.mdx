...
- On ESP8266 this feature requires the `restore_from_flash` feature to be enabled in the [ESP8266 platform](/components/esp8266/).
...
- <APIRef text="factory_reset.h" path="factory_reset/factory_reset.h" />
