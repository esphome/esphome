...
import teleinfoFullImg from './images/teleinfo-full.jpg';
import teleinfoStandardImg from './images/teleinfo-standard.jpg';
import teleinfoHistoricalImg from './images/teleinfo-historical.jpg';
...
<Figure
  src={teleinfoFullImg}
  alt=""
  caption="Linky electrical counter"
  layout="constrained"
/>
...
<Figure
  src={teleinfoStandardImg}
  alt=""
  caption="Linky electrical counter configured in standard mode."
  layout="constrained"
/>
...
<Figure
  src={teleinfoHistoricalImg}
  alt=""
  caption="Linky electrical counter configured in historical mode."
  layout="constrained"
/>
...
- <APIRef text="teleinfo.h" path="teleinfo/teleinfo.h" />
