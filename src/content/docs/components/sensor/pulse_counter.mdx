...
<Image src={pulseCounterImg} layout="constrained" alt="" />
...
> [!NOTE]
> See [integration sensor](/components/sensor/integration/) for summing up pulse counter
> values over time.
...
## `pulse_counter.set_total_pulses` Action
...
- <APIRef text="pulse_counter_sensor.h" path="pulse_counter/pulse_counter_sensor.h" />
