...
<Image src={pulseCounterVsPulseMeterImg} layout="constrained" alt="" />
...
## `pulse_meter.set_total_pulses` Action
...
- <APIRef text="pulse_meter_sensor.h" path="pulse_meter/pulse_meter_sensor.h" />
