...
import msa311FullImg from './images/msa311-full.jpg';
import msa3xxUiImg from './images/msa3xx-ui.png';
import APIRef from '@components/APIRef.astro';

<span id="msa3xx-component"></span>
...
<Figure
  src={msa311FullImg}
  alt=""
  caption="Module breakout board with MSA311 sensor."
  layout="constrained"
/>
...
<Figure
  src={msa3xxUiImg}
  alt=""
  caption="Example of MSA3xx sensor representation in ESPHome dashboard."
  layout="constrained"
/>
...
- <APIRef text="msa3xxx.h" path="msa3xxx/msa3xxx.h" />
