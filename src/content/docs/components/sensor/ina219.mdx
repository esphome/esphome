...
import ina219FullImg from './images/ina219-full.jpg';
import ina219UiImg from './images/ina219-ui.png';
...
<Figure
  src={ina219FullImg}
  alt=""
  caption="INA219 DC Current Sensor."
  layout="constrained"
/>

<Image src={ina219UiImg} layout="constrained" alt="" />
...
- <APIRef text="ina219.h" path="ina219/ina219.h" />
