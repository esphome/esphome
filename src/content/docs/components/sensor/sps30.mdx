...
import sensirionPmImg from './images/sensirion-pm.png';
import sps30WiringImg from './images/sps30-wiring.png';
...
<Image src={sensirionPmImg} layout="constrained" alt="" />
...
<Image src={sps30WiringImg} layout="constrained" alt="" />
...
<span id="sps30-start_fan_autoclean_action"></span>
...
- [SGP30 CO₂ and Volatile Organic Compound Sensor](/components/sensor/sgp30/)
- <APIRef text="sps30.h" path="sps30/sps30.h" />
