...
import ltr303FullImg from './images/ltr303-full.jpg';
...
<Figure
  src={ltr303FullImg}
  alt=""
  caption="LTR-329 and LTR-303 Ambient Light Sensors."
  layout="constrained"
/>

<Figure
  src={ltr303UiImg}
  caption="LTR-303 Sensor in Home Assistant UI."
  layout="constrained"
  alt=""
/>
...
<Figure
  src={ltr303SpectralImg}
  alt=""
  caption="CH0 and CH1 typical spectral response"
  layout="constrained"
/>
...
- <APIRef text="ltr_als_ps.h" path="ltr_als_ps/ltr_als_ps.h" />
