...
<Figure
  src="/images/tx20.jpg"
  alt=""
  caption="TX20 / TX23 Wind Speed / Direction."
  layout="constrained"
  width={239}
  height={300}
/>
...
> There are various alternatives though, and since ESPHome has a [Modbus](/components/modbus/), any model supporting RS485 connection
...
- <APIRef text="tx20.h" path="tx20/tx20.h" />
