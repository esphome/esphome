...
[Esp32 Ble Tracker](/components/esp32_ble_tracker/). This component will track the tank level,
...
> See [Mopeka Pro Check](/components/sensor/mopeka_pro_check/) for Mopeka Pro Check sensors support.

<Figure
  src="/images/mopeka_std_check.jpg"
  alt=""
  caption="Mopeka Std Check LP over BLE."
  layout="constrained"
  width={247}
  height={204}
/>
...
- <APIRef text="mopeka_std_check.h" path="mopeka_std_check/mopeka_std_check.h" />
