...
import inkbirdIsbth1MiniFullImg from './images/inkbird_isbth1_mini-full.jpg';
import inkbirdIsbth1MiniUiImg from './images/inkbird_isbth1_mini-ui.png';
...
Low Energy devices using the [Esp32 Ble Tracker](/components/esp32_ble_tracker/). This component will track the
...
<Figure
  src={inkbirdIsbth1MiniFullImg}
  alt=""
  caption="Inkbird IBS-TH1 Mini Temperature and Humidity Sensor over BLE."
  layout="constrained"
/>

<Image src={inkbirdIsbth1MiniUiImg} layout="constrained" alt="" />
...
- <APIRef text="inkbird_ibsth1_mini.h" path="inkbird_ibsth1_mini/inkbird_ibsth1_mini.h" />
