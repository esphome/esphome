...
<Figure
  src={mlx90393FullImg}
  alt=""
  caption="MLX90393 Triple-axis Magnetometer"
  layout="constrained"
/>
...
<Figure
  src={mlx90393ResolutionImg}
  alt=""
  caption="Resolution options and which bits they report to ESPHome. `DIV_8` sends the most significant 16 bits, while `DIV_1` sends the least significant bits."
  layout="constrained"
/>
