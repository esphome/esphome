...
> from Home Assistant, use the [Home Assistant Text Sensor](/components/text_sensor/homeassistant/).
...
- <APIRef text="homeassistant_sensor.h" path="homeassistant/sensor/homeassistant_sensor.h" />
