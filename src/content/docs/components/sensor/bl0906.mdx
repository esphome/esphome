...
import athomEm2Img from './images/athom-em2.png';
import athomEm6Img from './images/athom-em6.png';
...
<Figure
  src={athomEm2Img}
  alt=""
  caption="Athom Single Phase 2 channels Real Time Whole House Energy Meter."
  layout="constrained"
/>
...
<Figure
  src={athomEm6Img}
  alt=""
  caption="Athom Single Phase 6 channels Real Time Whole House Energy Meter."
  layout="constrained"
/>
...
- [CSE7761 Power Sensor](/components/sensor/cse7761/)
- [BL0939 Power Sensor](/components/sensor/bl0939/)
- [Belling BL0940 Energy Monitor](/components/sensor/bl0940/)
- <APIRef text="bl0906.h" path="bl0906/bl0906.h" />
