...
import veml7700FullImg from './images/veml7700-full.jpg';
...
<Figure
  src={veml7700FullImg}
  alt=""
  caption="VEML7700 Ambient Light Sensor on a board and standalone sensors."
  layout="constrained"
/>
...
<Figure
  src={veml7700UiImg}
  alt=""
  caption="VEML sensor in Home Assistant UI."
  layout="constrained"
/>
...
<Figure
  src={veml7700SpectralImg}
  alt=""
  caption="ALS and WHITE channels spectral response"
  layout="constrained"
/>
...
Where:
- `counts` - sensor readings, counts
- `resolution` - sensor resolution for given integration time and gain, lx/counts
- `lux` - calculated illumination, lx
- `lux_comp` - compensated illumination, lx
...
- <APIRef text="veml7700.h" path="veml7700/veml7700.h" />
