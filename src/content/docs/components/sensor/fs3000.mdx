...
<Figure
  src="/images/fs3000.jpg"
  alt=""
  caption="FS3000 Air Velocity Sensor. (Credit: [SparkFun](https://www.sparkfun.com/products/18377), image compressed)"
  layout="constrained"
  width={300}
  height={220}
/>
...
- <APIRef text="fs3000.h" path="fs3000/fs3000.h" />
