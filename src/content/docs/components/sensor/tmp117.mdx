...
<Figure
  src="/images/tmp117.jpg"
  alt=""
  caption="TMP117 Temperature Sensor. (Credit: [Sparkfun](https://www.sparkfun.com/products/15805), image cropped and compressed)"
  layout="constrained"
  width={277}
  height={300}
/>
...
<span id="tmp117_i2c_addresses"></span>
