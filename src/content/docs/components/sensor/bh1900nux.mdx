...
import bh1900nuxEvk001Img from './images/bh1900nux-evk-001.png';

<span id="bh1900nux"></span>
...
<Image src={bh1900nuxEvk001Img} layout="constrained" alt="BH1900NUX-EVK-001 Evaluation Board" />
