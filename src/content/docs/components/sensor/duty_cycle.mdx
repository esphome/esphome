...
import dutyCycleUiImg from './images/duty_cycle-ui.png';
...
<Image src={dutyCycleUiImg} layout="constrained" alt="" />
...
- <APIRef text="duty_cycle_sensor.h" path="duty_cycle/duty_cycle_sensor.h" />
