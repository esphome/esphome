...
<Figure
  src={bme680FullImg}
  alt=""
  caption="BME680 Temperature, Pressure & Humidity Sensor."
  layout="constrained"
/>
...
<Image src={bme680UiImg} layout="constrained" alt="" />

<span id="bme680-oversampling"></span>
...
- <APIRef text="bme680.h" path="bme680/bme680.h" />
