...
> [!NOTE]
> The Nextion can receive an integer but it can only send 3 bytes for a negative integer. The range if using the [Nextion Custom Sensor Protocol](#nextion-custom-sensor-protocol) is:
...
some more advanced functions (see the full <APIRef text="nextion_sensor.h" path="nextion/sensor/nextion_sensor.h" /> for more info).

<span id="nextion_sensor_set_state"></span>
...
<span id="nextion_sensor_update"></span>

- `update()`  : Poll from the Nextion

<span id="nextion_sensor_settings"></span>
...
To have the Nextion send the data you can use the [Nextion Custom Sensor Protocol](#nextion-custom-sensor-protocol) for this. Add the [Nextion Custom Sensor Protocol](#nextion-custom-sensor-protocol) to the
...
- This automation reflects the same protocol described in [Nextion Custom Sensor Protocol](#nextion-custom-sensor-protocol).
...
- <APIRef text="nextion_sensor.h" path="nextion/sensor/nextion_sensor.h" />
