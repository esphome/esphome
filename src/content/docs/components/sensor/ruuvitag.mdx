...
import ruuvitagFullImg from './images/ruuvitag-full.jpg';
import ruuvitagUiImg from './images/ruuvitag-ui.jpg';
import APIRef from '@components/APIRef.astro';

The `ruuvitag` sensor platform lets you track the output of RuuviTag
Bluetooth Low Energy devices using the [Esp32 Ble Tracker](/components/esp32_ble_tracker/).
...
<Figure
  src={ruuvitagFullImg}
  alt=""
  caption="RuuviTagSensor over BLE."
  layout="constrained"
/>

<Image src={ruuvitagUiImg} layout="constrained" alt="" />
...
- <APIRef text="ruuvitag.h" path="ruuvitag/ruuvitag.h" />
