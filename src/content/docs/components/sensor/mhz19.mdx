...
<Figure
  src={mhz19FullImg}
  alt=""
  caption="MH-Z19 CO_2 and Temperature Sensor."
  layout="constrained"
/>
...
<Figure
  src={mhz19PinsImg}
  alt=""
  caption="Pins on the MH-Z19. Only the ones marked with a red circle need to be connected."
  layout="constrained"
/>

<span id="mhz19-calibrate_zero_action"></span>
...
<span id="mhz19-abc_enable_action"></span>
...
<span id="mhz19-abc_disable_action"></span>
...
<span id="mhz19-detection_range_set_action"></span>
...
- <APIRef text="mhz19.h" path="mhz19/mhz19.h" />
