...
import thermoproTp357FullImg from './images/thermopro_tp357-full.jpg';
...
<Figure
  src={thermoproTp357FullImg}
  alt=""
  caption="ThermoPro TP357 Temperature and Humidity Sensor over BLE."
  layout="constrained"
/>
...
- <APIRef text="thermopro_ble.h" path="thermopro_ble/thermopro_ble.h" />
