...
<Figure
  src="/images/sdp31.jpg"
  alt=""
  caption="SDP31 Differential Pressure Sensor. (Credit: [Sparkfun](https://www.sparkfun.com/products/17874), image cropped and compressed)"
  layout="constrained"
  width={300}
  height={300}
/>
...
- <APIRef text="sdp3x.h" path="sdp3x/sdp3x.h" />
