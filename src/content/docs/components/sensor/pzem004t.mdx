...
> For using the newer V3 variant of this sensor or boards marked with PZEM-004T-100A-D-P(V1.0) please see [pzemac](/components/sensor/pzemac/).
...
- <APIRef text="pzem004t.h" path="pzem004t/pzem004t.h" />
