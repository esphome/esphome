...
import ltr390FullImg from './images/ltr390-full.jpg';
...
<Image src={ltr390FullImg} layout="constrained" alt="" />
...
$$
\text{lux} = \frac{0.6 \times \text{als}}{\text{gain} \times \text{int}/100} \times \text{wfac}
$$
...
- <APIRef text="ltr390.h" path="ltr390/ltr390.h" />
