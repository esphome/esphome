...
import t6615Img from './images/t6615.png';
import t6615PinsImg from './images/t6615-pins.png';
...
<Figure
  src={t6615PinsImg}
  alt=""
  caption="Pins on the T6615. Only the ones marked with a red circle need to be connected."
  layout="constrained"
/>
...
- <APIRef text="t6615.h" path="t6615/t6615.h" />
