...
import ikeaVindriktningImg from './images/ikea-vindriktning.jpg';
...
<Figure
  src={ikeaVindriktningImg}
  alt=""
  caption="IKEA VINDRIKTNING Particulate Matter Sensor with PM1006 inside"
  layout="constrained"
/>
...
The implementation was inspired by [https://github.com/Hypfer/esp8266-vindriktning-particle-sensor](https://github.com/Hypfer/esp8266-vindriktning-particle-sensor); you can also see the pinout there.
...
- <APIRef text="pm1006.h" path="pm1006/pm1006.h" />
