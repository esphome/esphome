...
<Figure
  src="/images/tmp1075.jpg"
  alt=""
  caption="TMP1075 Temperature Sensor. (Credit: [Texas Instruments](https://www.ti.com/content/dam/ticom/images/products/ic/sensing-products/chips/tmp1075-technical-chip-shot.png), image cropped and compressed)"
  layout="constrained"
  width={298}
  height={255}
/>
...
<span id="tmp1075_i2c_addresses"></span>
