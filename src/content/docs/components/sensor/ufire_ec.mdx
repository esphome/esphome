...
<Image src="/images/ufire_ec.png" width={300} height={300} layout="constrained" alt="" />
...
<span id="sensor-ufire_ec-calibrate_probe_action"></span>
...
- <APIRef text="ufire_ec.h" path="ufire_ec/ufire_ec.h" />
