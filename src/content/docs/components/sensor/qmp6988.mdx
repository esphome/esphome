...
<Figure
  src="/images/qmp6988_env3.png"
  alt=""
  caption="QMP6988 Temperature and Pressure Sensor."
  layout="constrained"
  width={300}
  height={300}
/>
...
<span id="qmp6988-oversampling"></span>
...
- <APIRef text="qmp6988.h" path="qmp6988/qmp6988.h" />
