...
import m5stack8angleImg from './images/m5stack_8angle.jpg';
...
<Figure
  src={m5stack8angleImg}
  alt=""
  caption="The m5stack_8angle unit."
  layout="constrained"
/>
...
- <APIRef text="m5stack_8angle.h" path="m5stack_8angle/m5stack_8angle.h" />
