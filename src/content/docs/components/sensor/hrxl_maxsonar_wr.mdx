...
import hrxlMaxsonarWrFullImg from './images/hrxl_maxsonar_wr-full.jpg';
...
<Figure
  src={hrxlMaxsonarWrFullImg}
  alt=""
  caption="MB7388 HRXL-MaxSonar-WRMLT Ultrasonic Distance Sensor."
  layout="constrained"
/>
...
- <APIRef text="hrxl_maxsonar_wr.h" path="hrxl_maxsonar_wr/hrxl_maxsonar_wr.h" />
