...
import bme680BsecUiImg from './images/bme680-bsec-ui.png';
...
>
> - We recommend using the newer [bme68x_bsec2](/components/sensor/bme68x_bsec2/) component whenever possible.
...
<Figure
  src={bme680FullImg}
  alt=""
  caption="BME680 Temperature, Pressure, Humidity & Gas Sensor."
  layout="constrained"
/>
...
<Image src={bme680BsecUiImg} layout="constrained" alt="" />
...
- <APIRef text="bme680_bsec.h" path="bme680_bsec/bme680_bsec.h" />
