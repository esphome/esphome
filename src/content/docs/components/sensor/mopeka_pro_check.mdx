...
import mopekaProCheckLippertImg from './images/mopeka_pro_check_lippert.jpg';
...
Energy devices using the [Esp32 Ble Tracker](/components/esp32_ble_tracker/). This component
...
>
> See [Mopeka Std Check](/components/sensor/mopeka_std_check/) for original Mopeka Check sensors support.

<Figure
  src="/images/mopeka_pro_check.jpg"
  alt=""
  caption="Mopeka Pro Check LP over BLE."
  layout="constrained"
  width={244}
  height={248}
/>
...
<Figure
  src={mopekaProCheckLippertImg}
  alt=""
  caption="Lippert™ Propane Tank Sensor"
  layout="constrained"
/>
...
+ <APIRef text="mopeka_pro_check.h" path="mopeka_pro_check/mopeka_pro_check.h" />
