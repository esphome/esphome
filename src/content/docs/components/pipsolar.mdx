...
<Figure
  src="/images/pipsolar.jpg"
  alt=""
  caption="pip4048 compatible PV Inverter."
  layout="constrained"
  width={193}
  height={300}
/>
...
<span id="pipsolaroutput_set_level_action"></span>
...
- **value** (**Required**, percentage, [templatable](/automations/templates)): The target level.
