...
import st7567FullImg from './images/st7567-full.jpg';
...
<Figure
  src={st7567FullImg}
  alt=""
  caption="ST7567A based LCD Graphic Display (I²C)"
  layout="constrained"
/>
...
- <APIRef text="st7567.h" path="st7567/st7567.h" />
