...
> [!WARNING]
> This component has been made redundant since the ST7701S is now supported by the [Mipi Rgb](/components/display/mipi_rgb/).
...
<Figure
  src="/images/indicator.jpg"
  alt=""
  caption="Sensecap Indicator display"
  layout="constrained"
  width={294}
  height={300}
/>
...
- <APIRef text="st7701s.h" path="st7701s/st7701s.h" />
