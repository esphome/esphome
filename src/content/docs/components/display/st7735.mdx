...
<Figure
  src="/images/st7735.jpg"
  alt=""
  caption="ST7735 Display"
  layout="constrained"
  width={300}
  height={225}
/>
...
> [!WARNING]
> This component has been made redundant since the ST7735 is now supported by the [Mipi Spi](/components/display/mipi_spi/).
...
- <APIRef text="st7735.h" path="st7735/st7735.h" />
