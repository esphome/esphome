...
import tDisplayAmoledImg from './images/t-display-amoled.jpg';
import APIRef from '@components/APIRef.astro';

<span id="qspi_dbi"></span>
...
> [!WARNING]
> This component has been made redundant since this class of displays is now supported by the [Mipi Spi](/components/display/mipi_spi/)
...
<Figure
  src={tDisplayAmoledImg}
  alt=""
  caption="Lilygo T-Display S3 AMOLED"
  layout="constrained"
/>
...
- <APIRef text="qspi_dbi.h" path="qspi_dbi/qspi_dbi.h" />
