...
> [!WARNING]
> This component has been made redundant since this class of displays is now supported by the [Mipi Rgb](/components/display/mipi_rgb/)
...
<Figure
  src="/images/waveshare_touch-s3.jpg"
  alt=""
  caption="Waveshare ESP32-S3 Touch 4.3"
  layout="constrained"
  width={293}
  height={220}
/>
...
- <APIRef text="rpi_dpi_rgb.h" path="rpi_dpi_rgb/rpi_dpi_rgb.h" />
