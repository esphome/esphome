...
import waveshareEpaperFullImg from './images/waveshare_epaper-full.jpg';
...
<Figure
  src={waveshareEpaperFullImg}
  alt=""
  caption="Waveshare E-Paper 2.9 Inch E-Paper Display."
  layout="constrained"
/>

<Figure
  src={waveshareEpaper7colorAcepFullImg}
  alt=""
  caption="Waveshare E-Paper 7.3 Inch ACeP 7-Color E-Paper Display."
  layout="constrained"
/>
...
<Image src={waveshareEpaperPinsImg} layout="constrained" alt="" />
...
- <APIRef text="waveshare_epaper.h" path="waveshare_epaper/waveshare_epaper.h" />
