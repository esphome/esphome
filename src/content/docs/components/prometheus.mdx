...
[Web Server](/components/web_server/) in order to integrate a [Prometheus](https://prometheus.io/) installation.
...
- <APIRef text="prometheus_handler.h" path="prometheus/prometheus_handler.h" />
