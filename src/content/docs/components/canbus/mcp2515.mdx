...
<Image src={canbusMcp2515ResistorImg} layout="constrained" alt="" />

A more complex option is to properly convert the 3.3V and 5V logic levels with a level shifter.

<Image src={canbusMcp2515Txs0108eImg} layout="constrained" alt="" />

## See Also

- [Canbus Component](/components/canbus/)
- <APIRef text="canbus.h" path="canbus/canbus.h" />
