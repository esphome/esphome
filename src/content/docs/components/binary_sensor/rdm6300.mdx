...
import rdm6300FullImg from './images/rdm6300-full.jpg';
import rdm6300UiImg from './images/rdm6300-ui.png';
import APIRef from '@components/APIRef.astro';

<span id="rdm6300-component"></span>
