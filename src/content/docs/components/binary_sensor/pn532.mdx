...
import pn532FullImg from './images/pn532-full.jpg';
import pn532SpiImg from './images/pn532-spi.jpg';
import APIRef from '@components/APIRef.astro';

<span id="pn532-component"></span>
...
<Figure
  src={pn532SpiImg}
  alt=""
  caption="Example for hooking up the PN532 via SPI. Notice the position of the two switches on the right."
  layout="constrained"
/>

<span id="pn532-on_tag"></span>
...
<span id="pn532-on_tag_removed"></span>
