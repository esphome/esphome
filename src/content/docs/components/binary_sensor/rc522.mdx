...
import rc522FullImg from './images/rc522-full.jpg';
import APIRef from '@components/APIRef.astro';

<span id="rc522-component"></span>

<Image src={rc522FullImg} layout="constrained" alt="" />
...
that establishes the connection to the RC522 via [SPI](/components/spi). Using [RC522 binary sensors](#rc522-binary-sensor),
...
[RC522 binary sensors](#rc522-binary-sensor) you can then create individual binary sensors that track if
...
<span id="rc522-on_tag_removed"></span>
...
- <APIRef text="rc522.h" path="rc522/rc522.h" />
