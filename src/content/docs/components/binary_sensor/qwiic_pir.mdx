...
<Figure
  src="/images/qwiic_pir.jpg"
  alt=""
  caption="SparkFun Qwiic PIR sensor. (Credit: [Sparkfun](https://www.sparkfun.com/products/17374), image cropped and compressed)"
  layout="constrained"
  width={300}
  height={300}
/>
...
- <APIRef text="qwiic_pir.h" path="qwiic_pir/qwiic_pir.h" />
