...
import mpr121FullImg from './images/mpr121-full.jpg';
import APIRef from '@components/APIRef.astro';

<span id="mpr121-component"></span>
...
<Figure
  src={mpr121FullImg}
  alt=""
  caption="MPR121 Capacitive Touch Sensor. Image by [Adafruit](https://www.adafruit.com)."
  layout="constrained"
/>
...
- <APIRef text="mpr121.h" path="mpr121/mpr121.h" />
