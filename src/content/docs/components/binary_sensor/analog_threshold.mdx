...
(i.e. [sensor](/components/sensor/) readings)
...
Additionally a [delay filter](/components/binary_sensor#binary-sensor-filters) could be used to only change
...
- <APIRef text="analog_threshold_binary_sensor.h" path="analog_threshold/analog_threshold_binary_sensor.h" />
