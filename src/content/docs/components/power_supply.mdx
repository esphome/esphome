...
import powerSupplyAtxImg from './images/power_supply-atx.jpg';
...
[Output Component](/components/output/) and
...
<Image src={powerSupplyAtxImg} layout="constrained" alt="" />
...
- <APIRef text="power_supply.h" path="power_supply/power_supply.h" />
