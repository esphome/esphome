...
<span id="config-touchscreen"></span>
...
<span id="touchscreen-touchpoint"></span>

## `TouchPoint` Argument Type

Both the [`on_touch` Trigger](#touchscreen-on_touch) and [`on_update` Trigger](#touchscreen-on_update) have an argument of the type <APIStruct text="touchscreen::TouchPoint" path="touchscreen::TouchPoint" /> in a
...
<span id="touchscreen-on_touch"></span>
...
<span id="touchscreen-on_update"></span>
...
This trigger provides one argument named `touches` of type <APIRef text="touchscreen::TouchPoints_t" path="touchscreen/touchscreen.h" /> which has a list of
...
<span id="touchscreen-on_release"></span>
...
- [Binary Sensor Filters](/components/binary_sensor#binary-sensor-filters)
