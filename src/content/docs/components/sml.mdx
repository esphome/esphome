...
import smlLogImg from './images/sml-log.png';
...
<Figure
  src={smlLogImg}
  alt=""
  caption="OBIS information in the log of the `SML` component"
  layout="constrained"
/>
...
- <APIRef text="sml.h" path="sml/sml.h" />
