...
import sunGtil2ControllerBoardImg from './images/sun_gtil2_controller_board.png';
import sunGtil2DisplayBoardImg from './images/sun_gtil2_display_board.png';
import sunGtil2SchematicImg from './images/sun_gtil2_schematic.png';
...
> [Modbus](/components/modbus_controller/) component instead.

<Figure
  src={sunGtil2ControllerBoardImg}
  caption="Pinout of the inverter's controller board"
  layout="constrained"
  alt=""
/>

<Figure
  src={sunGtil2DisplayBoardImg}
  caption="Pinout of the inverter's display board"
  layout="constrained"
  alt=""
/>

<Figure
  src={sunGtil2SchematicImg}
  caption="Simplified connection diagram"
  layout="constrained"
  alt=""
/>
