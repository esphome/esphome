...
import openthermShieldImg from './images/opentherm-shield.png';
...
<Figure
  src={openthermShieldImg}
  alt=""
  caption="DIYLESS Master OpenTherm Shield."
  layout="constrained"
/>
...
<span id="on-the-fly-message-editing"></span>
...
You can check the <APIStruct text="OpenthermData" path="opentherm::OpenthermData" /> for the list of all available fields.
...
<span id="thermostat-pid-basic"></span>
...
- <APIRef text="API Reference: OpenthermOutput" path="opentherm/output/output.h" />
- <APIRef text="API Reference: OpenthermSwitch" path="opentherm/switch/switch.h" />
