...
<Figure
  src={climateUiImg}
  caption="Climate Device UI in Home Assistant."
  layout="constrained"
  alt=""
/>
...
<span id="climate-control_action"></span>
...
<span id="climate-on_control_trigger"></span>
...
- <APIRef text="climate.h" path="climate/climate.h" />
