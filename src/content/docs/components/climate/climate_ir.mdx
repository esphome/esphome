...
<Image src={climateUiImg} layout="constrained" alt="" />
...
However, when receiver is supported, you can optionally add a [Remote Receiver](/components/remote_receiver/)
...
>   internal temperature sensor; a value of 30 seconds seems to work well. See [Sensor](/components/sensor/)
...
for example what mode the device is in). By setting up a [remote_receiver](/components/remote_receiver/)
...
> internal temperature sensor; a value of 2 minutes seems to work well. See [Sensor](/components/sensor/)
> for more information.
...
- <APIRef text="ballu.h" path="ballu/ballu.h" />
- <APIRef text="climate_ir_lg.h" path="climate_ir_lg/climate_ir_lg.h" />
- <APIRef text="coolix.h" path="coolix/coolix.h" />
- <APIRef text="daikin.h" path="daikin/daikin.h" />
- <APIRef text="fujitsu_general.h" path="fujitsu_general/fujitsu_general.h" />
- <APIRef text="gree.h" path="gree/gree.h" />
...
- <APIRef text="whynter.h" path="whynter/whynter.h" />
- <APIRef text="yashima.h" path="yashima/yashima.h" />
