...
>
> We recommend putting a filter on the sensor (see filters in [Sensor](/components/sensor/)) and
...
<Image src={deadband1Img} layout="constrained" alt="" />
...
<Image src={deadband2Img} layout="constrained" alt="" />
...
1. Create a [template button](/components/button/template/) to start autotuning later:
...
- <APIRef text="pid_climate.h" path="pid/pid_climate.h" />
- <APIRef text="PID Autotuner" path="pid/pid_autotuner.h" />
