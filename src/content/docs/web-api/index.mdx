...
import eventSourceImg from './images/event-source.png';
...
or using the [Web Server Section](/components/web_server/) in ESPHome.
...
<Figure
  src={eventSourceImg}
  caption="Example payload of the event source API."
  layout="constrained"
  alt=""
/>
