...
CONF_TILT_CLOSE_SPEED = 'tilt_close_speed'
CONF_TILT_CLOSED_VALUE = 'tilt_closed_value'
CONF_TILT_OPEN_SPEED = 'tilt_open_speed'
CONF_TILT_OPENED_VALUE = 'tilt_opened_value'
CONF_TIME = 'time'
