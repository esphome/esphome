...
CONF_SMOKE = "smoke"                                                # added to support Xiaomi (Honeywell)  smoke sensor JTYJGD03MI
CONF_SONY = "sony"
CONF_SOURCE = "source"
...
ICON_SMOKE_SENSOR = "mdi:smoke-sensor"                                  # added to support Xiaomi (Honeywell)  smoke sensor JTYJGD03MI
...
DEVICE_CLASS_SMOKE = "smoke"                                       # added to support Xiaomi (Honeywell)  smoke sensor JTYJGD03MI
