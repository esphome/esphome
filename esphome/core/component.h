...
#pragma GCC diagnostic pop
 ...
 protected:
   ...
   */
  void set_component_source_(uint16_t index) { this->component_source_index_ = index; }
  ...
  // Bitfield packs into 16 bits: 9-bit source index (0-511) + 7-bit blocking threshold (0-127 centiseconds)
  uint16_t component_source_index_ : 9 {0};  ///< Index into component source PROGMEM lookup table (0 = not set)
  uint16_t warn_if_blocking_over_ : 7 {WARN_IF_BLOCKING_OVER_CS};  ///< Warn threshold in centiseconds (max 1270ms)
