...
#define USE_CAN_GATEWAY_SNAPSHOT
#define USE_CAN_GATEWAY_CYCLIC
#define USE_CAN_GATEWAY_STATS
#define USE_CAN_GATEWAY_ID_STATS
...
#define CAN_GATEWAY_INJECT_SLOTS 4
#define CAN_GATEWAY_TX_SLOTS 10
#define CAN_GATEWAY_CYCLIC_COUNT 2
#define CAN_GATEWAY_ID_STATS_MAX 32
