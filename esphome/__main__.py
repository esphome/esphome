...
def choose_upload_log_host(
    ...
    if (
        ...
        and CORE.data.get(KEY_CORE, {}).get(KEY_TARGET_PLATFORM) == PLATFORM_RP2
...
def upload_using_platformio(config: ConfigType, port: str) -> int:
    ...
    if CORE.data.get(KEY_CORE, {}).get(KEY_TARGET_PLATFORM) == PLATFORM_RP2:
        idedata = toolchain.get_idedata(config)
...
def upload_program(
    ...
    if port_type == PortType.SERIAL:
        ...
        elif CORE.target_platform == PLATFORM_RP2 or CORE.is_libretiny:
