...
class StorageJSON(object):
    def __init__(self, storage_version, name, description, esphome_version,
    ...
    @staticmethod
    def from_wizard(name, address, esp_platform, board, description):
        # type: (str, str, str, str, str) -> StorageJSON
        return StorageJSON(
            storage_version=1,
            name=name,
    ...
    def _load_impl(path):  # type: (str) -> Optional[StorageJSON]
        ...
        return StorageJSON(storage_version, name, description, esphome_version,
                           src_version, arduino_version, address, esp_platform, board, build_path,
                           firmware_bin_path, loaded_integrations)
