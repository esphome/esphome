...
BangBangClimateTargetTempConfig::BangBangClimateTargetTempConfig(float default_temperature, float hysteresis)
    : default_temperature(default_temperature), hysteresis(hysteresis) {}
