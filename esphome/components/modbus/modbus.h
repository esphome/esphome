...
///    semantics), and both clear variants detach the in-flight frame silently - including inside
///    on_no_response(), where the detach also swallows a READ_AGAIN's absorbed second request.
