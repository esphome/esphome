...
enum class FunctionCode : uint8_t {
  ...
  // Remove before 2027.2.0. Custom commands now carry their real function code (decoded from the PDU),
  // so the placeholder alias has no remaining use.
  CUSTOM ESPDEPRECATED("Use INVALID instead. Removed in 2027.2.0", "2026.8.0") = 0x00,
  READ_COILS = 0x01,
