...
from esphome.const import (
    CONF_HUMIDITY, CONF_ID, CONF_IIR_FILTER, CONF_OVERSAMPLING, CONF_PRESSURE, CONF_TEMPERATURE,
    ICON_GAUGE, ICON_THERMOMETER, ICON_WATER_PERCENT, UNIT_CELSIUS, UNIT_HECTOPASCAL, UNIT_PERCENT,
)
