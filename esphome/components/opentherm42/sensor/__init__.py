...
TYPES: dict[str, cv.Schema] = {
    ...
    CONF_CONTROL_OF_SPECIAL_APPLICATIONS_MAXIMUM_BOILER_CAPACITY: sensor.sensor_schema(
        unit_of_measurement="kW", accuracy_decimals=0, state_class="measurement"
    ),
    ...
    # §5.3.8.3 Class 8, ID 99 HB bits 0-3: Remote Override Operating Mode DHW (0..15).
    # 0=No override, 1=Auto, 2=Anti-Legionella, 3=Comfort, 4=Reduced, 5=Protection, 6=Off, 7..15=reserved.
    CONF_CONTROL_OF_SPECIAL_APPLICATIONS_REMOTE_OVERRIDE_OPERATING_MODE_DHW: _CODE_SCHEMA,
    # §5.3.8.3 Class 8, ID 99 LB bits 0-3: Remote Override Operating Mode Heating HC1 (0..15).
    # 0=No override, 1=Auto, 2=Comfort, 3=Precomfort, 4=Reduced, 5=Protection, 6=Off, 7..15=reserved.
    CONF_CONTROL_OF_SPECIAL_APPLICATIONS_REMOTE_OVERRIDE_OPERATING_MODE_HEATING_HC1: _CODE_SCHEMA,
    # §5.3.8.3 Class 8, ID 99 LB bits 4-7: Remote Override Operating Mode Heating HC2 (0..15), same
    # encoding as HC1.
    CONF_CONTROL_OF_SPECIAL_APPLICATIONS_REMOTE_OVERRIDE_OPERATING_MODE_HEATING_HC2: _CODE_SCHEMA,
}
