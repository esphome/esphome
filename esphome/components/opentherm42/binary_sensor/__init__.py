...
FINAL_VALIDATE_SCHEMA = cv.All(
    validate_requires_time_id(CONF_SENSOR_AND_INFORMATIONAL_DATA_TIME_SYNCHRONIZED),
    validate_requires_hub_option(
        [
            CONF_CONTROL_AND_STATUS_INFORMATION_APPLICATION_SPECIFIC_FAULT_FLAGS_SERVICE_REQUEST,
            CONF_CONTROL_AND_STATUS_INFORMATION_APPLICATION_SPECIFIC_FAULT_FLAGS_LOCKOUT_RESET,
        ...
        CONF_CONTROL_AND_STATUS_INFORMATION_APPLICATION_SPECIFIC_FAULT_FLAGS_UPDATE_INTERVAL,
        "any of id=5's fault-flag binary_sensors",
    ),
    validate_requires_hub_option(
        [
            CONF_CONTROL_AND_STATUS_INFORMATION_APPLICATION_SPECIFIC_FAULT_FLAGS_VENTILATION_HEAT_RECOVERY_SERVICE_REQUEST,
        ...
        CONF_CONTROL_AND_STATUS_INFORMATION_APPLICATION_SPECIFIC_FAULT_FLAGS_VENTILATION_HEAT_RECOVERY_UPDATE_INTERVAL,
        "any of id=72's fault-flag binary_sensors",
    ),
    validate_requires_hub_option(
        [
            CONF_CONTROL_AND_STATUS_INFORMATION_STATUS_VENTILATION_HEAT_RECOVERY_FAULT_INDICATION,
        ...
        CONF_CONTROL_AND_STATUS_INFORMATION_STATUS_VENTILATION_HEAT_RECOVERY_UPDATE_INTERVAL,
        "any of id=70's ventilation/heat-recovery status binary_sensors",
    ),
    validate_requires_hub_option(
        [
            CONF_CONTROL_AND_STATUS_INFORMATION_SOLAR_STORAGE_MODE_AND_STATUS_FAULT_INDICATION
        ...
        CONF_CONTROL_AND_STATUS_INFORMATION_SOLAR_STORAGE_MODE_AND_STATUS_UPDATE_INTERVAL,
        "the solar storage fault indication binary_sensor",
    ),
)
