...
void AirthingsWaveRadon::read_sensors_(uint8_t *raw_value, uint16_t value_len) {
...
bool AirthingsWaveRadon::is_valid_radon_value_(uint16_t radon) { return 0 <= radon && radon <= 16383; }

void AirthingsWaveRadon::update() {
...
void AirthingsWaveRadon::request_read_values_() {
