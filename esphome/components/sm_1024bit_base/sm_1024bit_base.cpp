#include "sm_1024bit_base.h"
#include "esphome/core/log.h"

namespace esphome {
namespace sm_1024bit_base {

static const char *const TAG = "sm_1024bit_base";

static const uint8_t SM_1024BIT_ADDR_STANDBY = 0x0;
static const uint8_t SM_1024BIT_ADDR_START_3CH = 0x8;
static const uint8_t SM_1024BIT_ADDR_START_2CH = 0x10;
static const uint8_t SM_1024BIT_ADDR_START_5CH = 0x18;
...
void SM_1024BIT_Base::loop() {
  ...
  if (this->pwm_amounts_[0] == 0 && this->pwm_amounts_[1] == 0 && this->pwm_amounts_[2] == 0 &&
    ...
    // Off / Sleep
    data[0] = this->model_id_ + SM_1024BIT_ADDR_STANDBY;
    for (int i = 1; i < 12; i++)
      data[i] = 0;
    ...
    data[0] = this->model_id_ + SM_1024BIT_ADDR_START_2CH;
    ...
    data[0] = this->model_id_ + SM_1024BIT_ADDR_START_3CH;
    ...
    // All channels
    data[0] = this->model_id_ + SM_1024BIT_ADDR_START_5CH;
...
void SM_1024BIT_Base::set_channel_value_(uint8_t channel, uint16_t value) {
...
void SM_1024BIT_Base::write_bit_(bool value) {
  this->clock_pin_->digital_write(false);
  this->data_pin_->digital_write(value);
  this->clock_pin_->digital_write(true);
}

void SM_1024BIT_Base::write_byte_(uint8_t data) {
...
void SM_1024BIT_Base::write_buffer_(uint8_t *buffer, uint8_t size) {
