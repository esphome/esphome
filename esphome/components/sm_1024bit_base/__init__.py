...
sm_1024bit_base_ns = cg.esphome_ns.namespace("sm_1024bit_base")
SM_1024BIT_Base = sm_1024bit_base_ns.class_("SM_1024BIT_Base", cg.Component)

SM_1024BIT_BASE_CONFIG_SCHEMA = cv.Schema(
    {
...
@coroutine
async def register_sm_1024bit_base(config):
