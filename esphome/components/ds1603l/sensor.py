...
CONF_DS1603L_PERCENTAGE = "ds1603l_percentage"
...
async def to_code(config):
    ...
    if CONF_DS1603L_PERCENTAGE in config:
        sens = await sensor.new_sensor(config[CONF_DS1603L_PERCENTAGE])
        cg.add(var.set_ds1603l_percentage_sensor(sens))
