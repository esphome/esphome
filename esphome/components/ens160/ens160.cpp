...
void ENS160Component::update() {
  ...
  if (status.has_value()) {
    ...
    // ESP_LOGD(TAG, "Status: ENS160_DATA_STATUS_RESERVED_A 0x%n", (ENS160_DATA_STATUS_RESERVED_A & (statusValue)) == ENS160_DATA_STATUS_RESERVED_A);
    // ESP_LOGD(TAG, "Status: ENS160_DATA_STATUS_VALID_B 0x%n", (ENS160_DATA_STATUS_VALID_B & (statusValue)) == ENS160_DATA_STATUS_VALID_B);
    // ESP_LOGD(TAG, "Status: ENS160_DATA_STATUS_VALID_A 0x%n", (ENS160_DATA_STATUS_VALID_A & (statusValue)) == ENS160_DATA_STATUS_VALID_A);
    // ESP_LOGD(TAG, "Status: ENS160_DATA_STATUS_NEWDAT 0x%n", (ENS160_DATA_STATUS_NEWDAT & (statusValue)) == ENS160_DATA_STATUS_NEWDAT);
    // ESP_LOGD(TAG, "Status: ENS160_DATA_STATUS_NEWGPR 0x%n", (ENS160_DATA_STATUS_NEWGPR & (statusValue)) == ENS160_DATA_STATUS_NEWGPR);
  } else {
