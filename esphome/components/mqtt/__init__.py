...
from esphome.const import CONF_AVAILABILITY, CONF_BIRTH_MESSAGE, CONF_BROKER, CONF_CLIENT_ID, \
    ...
    CONF_QOS, CONF_REBOOT_TIMEOUT, CONF_RETAIN, CONF_RETAIN_COMMANDS, CONF_SHUTDOWN_MESSAGE, \
    CONF_SSL_FINGERPRINTS, CONF_STATE_TOPIC, CONF_TOPIC, CONF_TOPIC_PREFIX, CONF_TRIGGER_ID, \
