...
# 定义两个开关的配置键
CONF_SWITCH_1 = "switch_out_led"
CONF_SWITCH_2 = "switch_run_led"
CONF_SWITCH_FACTORY_RESET = "switch_factory_reset"
CONF_SWITCH_ENVIRONMENTAL_CALIBRATION = "environmental_calibration"
...
CONFIG_SCHEMA = {
    ...
    cv.Optional(CONF_SWITCH_1): switch.switch_schema(
        C4002Switch1,
        device_class=DEVICE_CLASS_SWITCH,
        entity_category=ENTITY_CATEGORY_CONFIG,
        icon="mdi:lightbulb",  # 灯泡图标
    ),
    cv.Optional(CONF_SWITCH_2): switch.switch_schema(
        C4002Switch2,
        device_class=DEVICE_CLASS_SWITCH,
        entity_category=ENTITY_CATEGORY_CONFIG,
