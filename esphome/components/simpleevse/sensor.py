...
# Schema for sensors
set_charge_current_schema = sensor.sensor_schema(
    UNIT_AMPERE, ICON_EMPTY, 0, DEVICE_CLASS_CURRENT
)
actual_charge_current_schema = sensor.sensor_schema(
    UNIT_AMPERE, ICON_EMPTY, 0, DEVICE_CLASS_CURRENT
)
max_current_limit_schema = sensor.sensor_schema(
    UNIT_AMPERE, ICON_EMPTY, 0, DEVICE_CLASS_CURRENT
)
firmware_revision_schema = sensor.sensor_schema(
