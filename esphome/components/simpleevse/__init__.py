...
SimpleEvseComponent = simpleevse_ns.class_('SimpleEvseComponent', cg.Component, uart.UARTDevice)
...
@automation.register_action('simplevse.set_charging_current', SetChargingCurrentAction, cv.Schema({
...
@automation.register_action('simplevse.set_charging_enabled', SetChargingEnabled, cv.Schema({
    cv.GenerateID(CONF_ID): cv.use_id(SimpleEvseComponent),
