...
class DallasComponent : public PollingComponent {
 public:
  ...
  void set_ignore_error_when_no_sensors_found(bool ignore) { ignore_error_when_no_sensors_found_ = ignore; }
 ...
 protected:
  ...
  bool ignore_error_when_no_sensors_found_;
