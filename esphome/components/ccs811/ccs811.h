...
class CCS811Component : public PollingComponent, public i2c::I2CDevice {
 ...
 protected:
  ...
  bool status_has_error_() { return this->read_status().value_or(1) & 1; }
  bool status_app_is_valid_() { return this->read_status().value_or(0) & (1 << 4); }
  bool status_has_data_() { return this->read_status().value_or(0) & (1 << 3); }
