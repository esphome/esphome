...
class Nextion : public NextionBase, public PollingComponent, public uart::UARTDevice {
 ...
 protected:
   ...
   */
#ifdef ARDUINO
  TFTUploadResult upload_by_chunks_(HTTPClient &http_client, uint32_t &range_start);
#elif defined(USE_ESP_IDF)
  TFTUploadResult upload_by_chunks_(esp_http_client_handle_t http_client, uint32_t &range_start);
