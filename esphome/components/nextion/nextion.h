...
class Nextion : public NextionBase, public PollingComponent, public uart::UARTDevice {
 ...
 protected:
  ...
  static constexpr size_t NEXTION_MODEL_MAX_ = 24;   ///< Max observed ~18 chars from product numbering rules
  static constexpr size_t NEXTION_FW_MAX_ = 7;       ///< 'S' prefix + integer (e.g. 'S99' or `123`)
  static constexpr size_t NEXTION_SERIAL_MAX_ = 20;  ///< Consistently 16 hex chars across all documented examples
  char device_model_[NEXTION_MODEL_MAX_ + 1]{};
  char firmware_version_[NEXTION_FW_MAX_ + 1]{};
  char serial_number_[NEXTION_SERIAL_MAX_ + 1]{};
