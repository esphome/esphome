...
class Nextion : public NextionBase, public PollingComponent, public uart::UARTDevice {
 ...
 protected:
  ...
  char device_model_[25]{};     ///< Max observed ~18 chars from product numbering rules
  char firmware_version_[8]{};  ///< 'S' prefix + integer (e.g. 'S99' or `123`)
  char serial_number_[21]{};    ///< Consistently 16 hex chars across all documented examples
