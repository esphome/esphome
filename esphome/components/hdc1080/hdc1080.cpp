...
void HDC1080Component::update() {
  ...
  this->begin_measurement_();
}

void HDC1080Component::begin_measurement_() {
  // start temperature measurement
  if (this->write(&HDC1080_CMD_TEMPERATURE, 1) != i2c::ERROR_OK) {
    this->status_set_warning();
    return;
  }
  this->set_timeout(20, [this]() { this->get_temperature_(); });
}

void HDC1080Component::get_temperature_() {
  ...
  this->set_timeout(20, [this]() { this->get_humidity_(); });
}

void HDC1080Component::get_humidity_() {
