...
static const uint8_t PROGMEM INITCMD_CYD_ILI9342[] = {
  0xCF, 3, 0x00, 0XC1, 0X30,
  0xED, 4, 0x64, 0x03, 0X12, 0X81,
  0xE8, 3, 0x85, 0x00, 0x78,
  0xCB, 5, 0x39, 0x2C, 0x00, 0x34, 0x02,
  0xF7, 1, 0x20,
  0xEA, 2, 0x00, 0x00,
  ILI9XXX_PWCTR1 , 1, 0x10,  // VRH[5:0]
  ILI9XXX_PWCTR2, 1, 0x00,  // Power control: SAP[2:0];BT[3:0]
  ILI9XXX_VMCTR1, 2, 0x30, 0x30,  // VCM control
  ILI9XXX_VMCTR2, 1, 0xB7,  // VCM control2
  ILI9XXX_PIXFMT, 1, 0x55,
  ILI9XXX_MADCTL, 1, 0x08,  // Rotation 0 (portrait mode)
  ILI9XXX_FRMCTR1, 2, 0x00, 0x1A,
  ILI9XXX_DFUNCTR, 3, 0x08, 0x82, 0x27,   // Display Function Control
  0xF2, 1, 0x00, // 3Gamma Function Disable
  ILI9XXX_GAMMASET, 1, 0x01,  // Gamma curve selected
  ILI9XXX_GMCTRP1, 15,
  0x0F, 0x2A, 0x28, 0x08, 0x0E,
  0x08, 0x54, 0xA9, 0x43, 0x0A,
  0x0F, 0x00, 0x00, 0x00, 0x00,
  ILI9XXX_GMCTRN1, 15,
  0x00, 0x15, 0x17, 0x07, 0x11,
