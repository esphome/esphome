...
void CAP1188Component::setup() {
  ...
  ESP_LOGCONFIG(TAG, "   Product ID: %02x", (int) cap1188_product_id);
  ESP_LOGCONFIG(TAG, "   Manufacture ID: %02x", (int) cap1188_manufacture_id);
  ESP_LOGCONFIG(TAG, "   Revision: %02x", (int) cap1188_revision);
