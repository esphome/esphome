...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_MAX_CELL_IMPEDANCE): CELL_IMPEDANCE_SCHEMA,
        cv.Optional(CONF_MAX_CELL_IMPEDANCE_NUMBER): NUMBER_SCHEMA,
        cv.Optional(CONF_MIN_CELL_IMPEDANCE): CELL_IMPEDANCE_SCHEMA,
        cv.Optional(CONF_MIN_CELL_IMPEDANCE_NUMBER): NUMBER_SCHEMA,
    }
