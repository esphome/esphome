...
class MipiRgb : public display::Display {
 public:
  ...
  void write_to_display(int x_start, int y_start, int w, int h, const uint8_t *ptr, int x_offset, int y_offset,
                        int x_pad);
  bool check_buffer();
  ...
  void dump_pins(uint8_t start, uint8_t end, const char *name, uint8_t offset);
