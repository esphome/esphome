...
void Driver::processContent(Telegram *t) {
  ...
  if (i + 4 < content.size()) {
    ...
    vendor_values["0413"] = {
        offset, DVEntry(offset, DifVifKey("0413"), MeasurementType::Instantaneous, 0x13, {}, {}, 0, 0, 0, total)};
    double tmp = 0;
    ...
    t->addSpecialExplanation(offset, 4, KindOfData::CONTENT, Understanding::FULL, total.c_str(),
