...
enum class MapType {
  ...
  DecimalsToString  // Numbers are successively subtracted from input, each successfull subtraction translate into a
                    // text string.
};
