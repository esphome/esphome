...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractorAndLookup(
      "info", "Is it a three phase or single phase meter.", DEFAULT_PRINT_PROPERTIES,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::ErrorFlags),
      {
          {{"INFO_FLAGS",
            ...
            AutoMask,
            "",
            {{0x01020000, "SINGLE_PHASE_METER"}, {0x01010000, "THREE_PHASE_METER"}}}},
      });
  ...
  addNumericFieldWithExtractor("total_energy_consumption_tariff_{tariff_counter}",
                               "The total energy consumption recorded by this meter.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor(
      "target", "Last day?", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::DateTime).set(StorageNr(2)));

  addNumericFieldWithExtractor(
      "target_energy_consumption", "Last day energy consumption?", DEFAULT_PRINT_PROPERTIES, Quantity::Energy,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::AnyEnergyVIF).set(StorageNr(2)));

  addNumericFieldWithExtractor("target_energy_consumption_tariff_{tariff_counter}",
                               "Last day energy consumption for tariff?", DEFAULT_PRINT_PROPERTIES, Quantity::Energy,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build()
                                   .set(MeasurementType::Instantaneous)
                                   .set(VIFRange::AnyEnergyVIF)
  ...
  addNumericFieldWithExtractor("device", "Device date time when telegram was sent.", DEFAULT_PRINT_PROPERTIES,
                               Quantity::PointInTime, VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::DateTime));

  addNumericFieldWithExtractor(
      "voltage_at_phase_1", "Voltage for single phase meter.", DEFAULT_PRINT_PROPERTIES, Quantity::Voltage,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Voltage).set(SubUnitNr(0)));

  addNumericFieldWithExtractor(
      "voltage_at_phase_{subunit_counter}", "Voltage at phase L#.", DEFAULT_PRINT_PROPERTIES, Quantity::Voltage,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Voltage).set(SubUnitNr(1), SubUnitNr(3)));

  addNumericFieldWithExtractor(
      "current_at_phase_1", "Amperage for single phase meter.", DEFAULT_PRINT_PROPERTIES, Quantity::Amperage,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Amperage).set(SubUnitNr(0)));

  addNumericFieldWithExtractor("current_at_phase_{subunit_counter}", "Amperage at phase L#.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor("raw_frequency", "Raw input to frequency.",
                               DEFAULT_PRINT_PROPERTIES | PrintProperty::HIDE, Quantity::Frequency, VifScaling::None,
                               DifSignedness::Signed, FieldMatcher::build().set(DifVifKey("02FB2D")));

  addNumericFieldWithCalculator("frequency", "Frequency of AC.", DEFAULT_PRINT_PROPERTIES, Quantity::Frequency,
...
// {"media":"electricity","meter":"gransystems","name":"Gran101","id":"18046178","status":"OK","info":"SINGLE_PHASE_METER","total_energy_consumption_kwh":0.916,"total_energy_consumption_tariff_4_kwh":0,"total_energy_consumption_tariff_2_kwh":0.043,"total_energy_consumption_tariff_3_kwh":0,"total_energy_consumption_tariff_1_kwh":0.873,"target_datetime":"2021-01-28
// 00:00","target_energy_consumption_kwh":0.916,"target_energy_consumption_tariff_2_kwh":0.043,"target_energy_consumption_tariff_4_kwh":0,"target_energy_consumption_tariff_3_kwh":0,"target_energy_consumption_tariff_1_kwh":0.873,"device_datetime":"2021-01-28
// 19:15","voltage_at_phase_1_v":235,"current_at_phase_1_a":0,"frequency_hz":49.98,"timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"electricity","meter":"gransystems","name":"Gran301","id":"20100117","status":"RTC_ERROR","info":"THREE_PHASE_METER","total_energy_consumption_kwh":0,"total_energy_consumption_tariff_2_kwh":0,"total_energy_consumption_tariff_3_kwh":0,"total_energy_consumption_tariff_4_kwh":0,"total_energy_consumption_tariff_1_kwh":0,"target_datetime":"2021-01-28
// 00:00","target_energy_consumption_kwh":0,"target_energy_consumption_tariff_1_kwh":0,"target_energy_consumption_tariff_2_kwh":0,"target_energy_consumption_tariff_4_kwh":0,"target_energy_consumption_tariff_3_kwh":0,"device_datetime":"2021-01-28
// 19:08","voltage_at_phase_2_v":0,"voltage_at_phase_3_v":0,"voltage_at_phase_1_v":234.1,"current_at_phase_1_a":0,"current_at_phase_2_a":0,"current_at_phase_3_a":0,"frequency_hz":50,"timestamp":"1111-11-11T11:11:11Z"}
