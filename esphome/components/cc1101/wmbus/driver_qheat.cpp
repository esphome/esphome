...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
      ...
      {
          {
              {"ERROR_FLAGS",
               ...
               "OK",
               {
                   ...
                   {0x100, "SABOTAGE"},  // F8 - F1,2,3,5,6 longer than 8 hours, latching error, no more measurements
                                         // performed.
  ...
  addNumericFieldWithExtractor(
      "last_month_energy_consumption", "The total energy consumption recorded at the last day of the previous month.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(17)).set(VIFRange::AnyEnergyVIF));

  addStringFieldWithExtractor(
      "last_year_date", "Last day previous year when total energy consumption was recorded.", DEFAULT_PRINT_PROPERTIES,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(1)).set(VIFRange::Date));

  addNumericFieldWithExtractor(
      "last_year_energy_consumption", "The total energy consumption recorded at the last day of the previous year.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
...
// 13:40","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"}
...
// 13:58","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"}
...
// 17:24","device_error_date":"2127-15-31","timestamp":"1111-11-11T11:11:11Z"}
