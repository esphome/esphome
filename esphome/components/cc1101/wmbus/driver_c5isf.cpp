...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractorAndLookup(
      "status", "Status and error flags.", PrintProperty::STATUS | PrintProperty::INCLUDE_TPL_STATUS,
  ...
  for (int i = 0; i < 14; ++i) {
    addStringFieldWithExtractor(
        tostrprintf("prev_%d_month", i + 1), "The due date.", DEFAULT_PRINT_PROPERTIES,
        FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(32 + i)).set(VIFRange::Date));
  }
  ...
  for (int i = 0; i < 14; ++i) {
    addNumericFieldWithExtractor(
        tostrprintf("prev_%d_month", i + 1), "The total heat energy consumption recorded at end of previous month.",
        DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
        FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(32 + i)).set(VIFRange::AnyEnergyVIF));
  }
  ...
  for (int i = 0; i < 14; ++i) {
    addNumericFieldWithExtractor(
        tostrprintf("prev_%d_month", i + 1), tostrprintf("Previous month %d last date.", i + 1),
        DEFAULT_PRINT_PROPERTIES, Quantity::Volume, VifScaling::Auto, DifSignedness::Signed,
        FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(32 + i)).set(VIFRange::Volume));
  }

  // Telegram type T1B ///////////////////////////////////////////////////////

  addNumericFieldWithExtractor(
      "due_energy_consumption", "The total heat energy consumption at the due date.", DEFAULT_PRINT_PROPERTIES,
      Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(8)).set(VIFRange::AnyEnergyVIF));

  addStringFieldWithExtractor(
      "due_date", "The due date.", DEFAULT_PRINT_PROPERTIES,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(8)).set(VIFRange::Date));
  ...
  addNumericFieldWithExtractor(
      "total_energy_consumption_last_month", "The total heat energy consumption recorded at end of last month.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(StorageNr(32)).set(VIFRange::AnyEnergyVIF));

  addStringFieldWithExtractor("last_month_date", "The due date.", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::DateTime));

  addNumericFieldWithExtractor("max_power_last_month", "Maximum power consumption last month.",
  ...
  addNumericFieldWithExtractor(
      "flow_temperature", "The current forward heat media temperature.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor(
      "return_temperature", "The current return heat media temperature.", DEFAULT_PRINT_PROPERTIES,
      Quantity::Temperature, VifScaling::Auto, DifSignedness::Signed,
...
// {"id": "55445555","media": "water","meter": "c5isf","name": "Heat","prev_10_month":
// "2127-15-31","prev_10_month_kwh":-2147483648,"prev_10_month_m3":-21474836.48,"prev_11_month":
// "2127-15-31","prev_11_month_kwh":-2147483648,"prev_11_month_m3":-21474836.48,"prev_12_month":
// "2127-15-31","prev_12_month_kwh":-2147483648,"prev_12_month_m3":-21474836.48,"prev_13_month":
// "2127-15-31","prev_13_month_kwh":-2147483648,"prev_13_month_m3":-21474836.48,"prev_14_month":
// "2127-15-31","prev_14_month_kwh":-2147483648,"prev_14_month_m3":-21474836.48,"prev_1_month":
// "2017-04-01","prev_1_month_kwh": 0,"prev_1_month_m3": 0,"prev_2_month":
// "2127-15-31","prev_2_month_kwh":-2147483648,"prev_2_month_m3":-21474836.48,"prev_3_month":
// "2127-15-31","prev_3_month_kwh":-2147483648,"prev_3_month_m3":-21474836.48,"prev_4_month":
// "2127-15-31","prev_4_month_kwh":-2147483648,"prev_4_month_m3":-21474836.48,"prev_5_month":
// "2127-15-31","prev_5_month_kwh":-2147483648,"prev_5_month_m3":-21474836.48,"prev_6_month":
// "2127-15-31","prev_6_month_kwh":-2147483648,"prev_6_month_m3":-21474836.48,"prev_7_month":
// "2127-15-31","prev_7_month_kwh":-2147483648,"prev_7_month_m3":-21474836.48,"prev_8_month":
// "2127-15-31","prev_8_month_kwh":-2147483648,"prev_8_month_m3":-21474836.48,"prev_9_month":
// "2127-15-31","prev_9_month_kwh":-2147483648,"prev_9_month_m3":-21474836.48,"status": "ERROR","timestamp":
// "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 0,"total_energy_consumption_last_month_kwh":
// 0,"total_volume_m3": 0} |Heat;55445555;0;0;ERROR;1111-11-11 11:11.11
...
// {"due_date": "2022-01-01","due_energy_consumption_kwh": 0,"flow_temperature_c": 56.5,"id":
// "55445555","max_power_last_month_kw": 0,"media": "heat","meter": "c5isf","name":
// "Heat","power_kw": 2.5,"prev_10_month":
// "2127-15-31","prev_10_month_kwh":-2147483648,"prev_10_month_m3":-21474836.48,"prev_11_month":
// "2127-15-31","prev_11_month_kwh":-2147483648,"prev_11_month_m3":-21474836.48,"prev_12_month":
// "2127-15-31","prev_12_month_kwh":-2147483648,"prev_12_month_m3":-21474836.48,"prev_13_month":
// "2127-15-31","prev_13_month_kwh":-2147483648,"prev_13_month_m3":-21474836.48,"prev_14_month":
...
// "2127-15-31","prev_7_month_kwh":-2147483648,"prev_7_month_m3":-21474836.48,"prev_8_month":
// "2127-15-31","prev_8_month_kwh":-2147483648,"prev_8_month_m3":-21474836.48,"prev_9_month":
// "2127-15-31","prev_9_month_kwh":-2147483648,"prev_9_month_m3":-21474836.48,"return_temperature_c": 43.22,"status":
// "OK","timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh":
// 26,"total_energy_consumption_last_month_kwh": 0,"total_volume_m3": 2.242,"volume_flow_m3h": 0.164}
