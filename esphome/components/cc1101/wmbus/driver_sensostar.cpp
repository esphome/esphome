...
static bool ok = registerDriver([](DriverInfo &di) {
  ...
  di.setDefaultFields("name,id,total_kwh,total_water_m3,current_status,reporting_date,energy_consumption_at_reporting_"
                      "date_kwh,timestamp");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor("power_max", "The maximum power consumption over ?period?.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor("flow_water", "The flow of water.", DEFAULT_PRINT_PROPERTIES, Quantity::Flow,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::VolumeFlow));

  addNumericFieldWithExtractor("flow_water_max", "The maximum forward flow of water over a ?period?.",
  ...
  addNumericFieldWithExtractor("total_water", "The total amount of water that has passed through this meter.",
  ...
  addStringFieldWithExtractorAndLookup(
      "current_status", "Status and error flags.", DEFAULT_PRINT_PROPERTIES,
      ...
      {
          {
              {"ERROR_FLAGS",
               ...
               {// based on information published here:
                // https://www.engelmann.de/wp-content/uploads/2022/10/1080621004_2022-10-12_BA_S3_ES_Comm_en.pdf
  ...
  addNumericFieldWithExtractor(
      "energy_consumption_at_reporting_date", "The energy consumption at the last billing period date.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
  ...
  for (int i = 1; i <= 15; ++i) {
    ...
    addNumericFieldWithExtractor(
        name, info, DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
