...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor("a", "The current number of counted pulses from counter a.", DEFAULT_PRINT_PROPERTIES,
                               Quantity::Dimensionless, VifScaling::None, DifSignedness::Signed,
                               FieldMatcher::build().set(DifVifKey("0EFD3A")));

  addNumericFieldWithExtractor("b", "The current number of counted pulses from counter b.", DEFAULT_PRINT_PROPERTIES,
                               Quantity::Dimensionless, VifScaling::None, DifSignedness::Signed,
                               FieldMatcher::build().set(DifVifKey("8E40FD3A")));
}
}  // namespace
...
// {"media":"electricity","meter":"lansenpu","name":"COUNTB","id":"00023750","status":"PERMANENT_ERROR POWER_LOW
// SABOTAGE_ENCLOSURE","b_counter":870,"timestamp":"1111-11-11T11:11:11Z"} |COUNTB;00023750;PERMANENT_ERROR POWER_LOW
// SABOTAGE_ENCLOSURE;null;870;1111-11-11 11:11.11
