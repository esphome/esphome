...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor(
      "target", "The most recent billing period date.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Date).set(StorageNr(1)), Unit::DateLT);

  addNumericFieldWithExtractor(
      "target", "The total water consumption at the most recent billing period date.", DEFAULT_PRINT_PROPERTIES,
      Quantity::Volume, VifScaling::Auto, DifSignedness::Signed,
...
// {"id": "27604781","media": "water","meter": "weh_07","name": "Vattenn","target_date": "2021-09-30","target_m3":
// 0,"timestamp": "1111-11-11T11:11:11Z","total_m3": 37.299 } |Vattenn;27604781;37.299;1111-11-11 11:11.11
