...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractorAndLookup(
      "status", "Meter status from error flags and tpl status field.",
  ...
  addNumericFieldWithExtractor("total_energy_consumption", "The total heat energy consumption recorded by this meter.",
  ...
  addNumericFieldWithExtractor("total_volume", "The total heating media volume recorded by this meter.",
  ...
  addNumericFieldWithExtractor("volume_flow", "The current heat media volume flow.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor(
      "temperature_difference", "The difference between flow and return media temperatures.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor(
      "set", "The most recent billing period date.", DEFAULT_PRINT_PROPERTIES | PrintProperty::HIDE,
  ...
  addNumericFieldWithExtractor("consumption_at_set_date_{storage_counter}",
                               "The total water consumption at the historic date.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithCalculatorAndMatcher("set_date_{storage_counter}", "Unclear! What is the date really?",
...
// {"flow_temperature_c":21,"id":"93572431","media":"heat","meter":"microclima","meter_datetime":"2021-12-22
// 00:39","model_version":"000005","name":"Heat","parameter_set":"1110","power_kw":0,"return_temperature_c":21,"status":"OK","temperature_difference_c":-0.48,"timestamp":"1111-11-11T11:11:11Z","total_energy_consumption_kwh":1805,"total_volume_m3":297.994,"volume_flow_m3h":0}
