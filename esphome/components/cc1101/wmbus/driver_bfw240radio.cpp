...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericField("prev", Quantity::HCA, DEFAULT_PRINT_PROPERTIES,
  ...
  for (int i = 0; i < 18; ++i) {
    ...
    addNumericField(info, Quantity::HCA, DEFAULT_PRINT_PROPERTIES, about);
  }

  addStringField("device_date", "Device date when telegram was sent.", DEFAULT_PRINT_PROPERTIES);
}
