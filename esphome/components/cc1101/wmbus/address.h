...
*/
enum class IdentityMode { ID, ID_MFCT, FULL, NONE, INVALID };
...
struct AddressExpression {
  ...
  static void appendIdentity(IdentityMode im, AddressExpression *identity_expression, std::vector<Address> &as,
...
bool doesTelegramMatchExpressions(std::vector<Address> &addresses, std::vector<AddressExpression> &address_expressions,
                                  bool *used_wildcard);
