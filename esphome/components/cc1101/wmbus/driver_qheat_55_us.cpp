...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractor("key_date", "The key (billing) date", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build()
                                  .set(MeasurementType::Instantaneous)
  ...
  addNumericFieldWithExtractor("key_date", "The total energy consumption recorded at key (billing) date",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build()
                                   .set(MeasurementType::Instantaneous)
                                   .set(VIFRange::AnyEnergyVIF)
  ...
  addStringFieldWithExtractor("prev_month", "The date of end of last month.", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build()
                                  .set(MeasurementType::Instantaneous)
                                  .set(VIFRange::DateTime)
                                  .set(StorageNr(2))
  ...
  for (int i = 1; i <= 13; ++i) {
    ...
    addNumericFieldWithExtractor(key, info, DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto,
  ...
  addNumericFieldWithExtractor(
      "actuality_duration", "The time between the measurement and the sending of this telegram.",
...
// 15:42","total_energy_consumption_kwh":60800,"key_date":"2022-12-31
// 23:59","key_date_kwh":60691,"prev_month":"2022-12-31
