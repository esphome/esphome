...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringFieldWithExtractorAndLookup(
      ...
      FieldMatcher::build().set(DifVifKey("04FF22")),
      Translate::Lookup({
          {
              {"ERROR_FLAGS",
  ...
  addNumericFieldWithExtractor("total_volume", "The volume of water (3/68/Volume V1).", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor("volume_flow",
  ...
  addNumericFieldWithExtractor("power", "The current power flowing.", DEFAULT_PRINT_PROPERTIES, Quantity::Power,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::AnyPowerVIF));

  addNumericFieldWithExtractor("max_power", "The maximum power supplied.", DEFAULT_PRINT_PROPERTIES, Quantity::Power,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Maximum).set(VIFRange::AnyPowerVIF));

  addNumericFieldWithExtractor(
      "t1_temperature", "The forward temperature of the water (6/86/t2 actual 2 decimals).", DEFAULT_PRINT_PROPERTIES,
      Quantity::Temperature, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::FlowTemperature));

  addNumericFieldWithExtractor(
      "t2_temperature", "The return temperature of the water (7/87/t2 actual 2 decimals).", DEFAULT_PRINT_PROPERTIES,
      Quantity::Temperature, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::ReturnTemperature));

  addNumericFieldWithExtractor("max_flow", "The maximum flow of water that passed through this meter.",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Flow, VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Maximum).set(VIFRange::VolumeFlow));

  addNumericFieldWithExtractor("forward_energy", "The forward energy of the water (4/97/Energy E8).",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::None, DifSignedness::Signed,
                               FieldMatcher::build().set(DifVifKey("04FF07")), Unit::M3C);

  addNumericFieldWithExtractor("return_energy", "The return energy of the water (5/110/Energy E9).",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::None, DifSignedness::Signed,
                               FieldMatcher::build().set(DifVifKey("04FF08")), Unit::M3C);

  addStringFieldWithExtractor("meter_date", "The date and time (10/348/Date and time).", DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Date));

  addNumericFieldWithExtractor(
      "target_energy", "The energy consumption recorded by this meter at the set date (11/60/Heat energy E1/026C).",
      DEFAULT_PRINT_PROPERTIES, Quantity::Energy, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::AnyEnergyVIF).set(StorageNr(1)));

  addNumericFieldWithExtractor(
      "target_volume", "The amount of water that had passed through this meter at the set date (13/68/Volume V1).",
  ...
  addStringFieldWithExtractor(
      "target_date", "The most recent billing period date and time (14/348/Date and Time logged).",
      DEFAULT_PRINT_PROPERTIES,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Date).set(StorageNr(1)));

  addNumericFieldWithExtractor("operating_time", "How long the meter has been collecting data.",
                               DEFAULT_PRINT_PROPERTIES, Quantity::Time, VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build()
...
// {"id": "67676767","media": "heat","meter": "kamheat","name": "MyHeater","power_kw": 1.9,"status": "OK","target_date":
// "2019-10-31","target_energy_kwh": 0,"timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh":
// 44,"total_volume_m3": 0.99} |MyHeater;67676767;44;0.99;OK;1111-11-11 11:11.11
...
// "OK","target_date": "2021-11-30","target_energy_kwh": 11783.333333,"timestamp":
// "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 11925,"total_volume_m3": 3386.95}
...
// {"id": "46464646","media": "heat volume at inlet","meter": "kamheat","name": "MyHeaterMj","power_kw": 1.2,"status":
// "OK","target_date": "2021-11-30","target_energy_kwh": 11783.333333,"timestamp":
// "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 11925,"total_volume_m3": 3387.09}
...
// {"forward_energy_m3c": 65528,"id": "78780102","max_power_kw": -2.5,"media": "cooling load volume at outlet","meter":
// "kamheat","meter_date": "2020-08-18","name": "My403Cooling","return_energy_m3c": 71744,"status":
// "OK","t1_temperature_c": 17.24,"t2_temperature_c": 19.97,"target_date": "2020-08-01","target_energy_kwh":
// 239.722222,"target_volume_m3": 134.55,"timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh":
// 723.611111,"total_volume_m3": 364.737,"volume_flow_m3h": 0.237}
...
// {"forward_energy_m3c": 65530,"id": "78780102","max_power_kw": -2.5,"media": "cooling load volume at outlet","meter":
// "kamheat","meter_date": "2020-08-18","name": "My403Cooling","return_energy_m3c": 71747,"status":
// "OK","t1_temperature_c": 17.22,"t2_temperature_c": 19.95,"target_date": "2020-08-01","target_energy_kwh":
// 239.722222,"target_volume_m3": 134.55,"timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh":
// 723.611111,"total_volume_m3": 364.75,"volume_flow_m3h": 0.238} |My403Cooling;78780102;723.611111;364.75;OK;1111-11-11
// 11:11.11
...
// {"id": "78152801","media": "heat","meter": "kamheat","meter_date": "2021-09-25","name": "Heato","status":
// "OK","t1_temperature_c": 59.3,"t2_temperature_c": 46.49,"target_date": "2021-08-31","target_energy_kwh":
// 68112,"target_volume_m3": 2690.16,"timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh":
// 68457,"total_volume_m3": 2717.85,"volume_flow_m3h": 0.057} |Heato;78152801;68457;2717.85;OK;1111-11-11 11:11.11
...
// "2020-11-09","name": "Heater","return_energy_m3c": 9,"status": "SENSOR_T1_BELOW_MEASURING_RANGE
// SENSOR_T2_BELOW_MEASURING_RANGE V1_COMMUNICATION_ERROR","t1_temperature_c": 0,"t2_temperature_c": 0,"target_date":
// "2020-11-01","target_energy_kwh": 0,"target_volume_m3": 0,"timestamp":
// "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 444.444444,"total_volume_m3": 2.55,"volume_flow_m3h": 0}
// |Heater;80808081;444.444444;2.55;SENSOR_T1_BELOW_MEASURING_RANGE SENSOR_T2_BELOW_MEASURING_RANGE
// V1_COMMUNICATION_ERROR;1111-11-11 11:11.11
...
// {"forward_energy_m3c": 148532,"id": "77447744","media": "heat","meter": "kamheat","name":
// "Kamstrup_403_mbus","return_energy_m3c": 118520,"status":
// "OK","t1_temperature_c": 64.6,"t2_temperature_c": 45.16,"timestamp":
// "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 34510,"total_volume_m3": 2232.49,"volume_flow_m3h":
// 0.527,"operating_time_h": 43489.183333} |Kamstrup_403_mbus;77447744;34510;2232.49;OK;1111-11-11 11:11.11
...
// {"fabrication_no": "84853230",  "flow_return_temperature_difference_c": 37.06,  "forward_energy_m3c": 67136,  "id":
// "32323232",  "max_flow_m3h": 22.75,  "max_power_kw": 869,  "media": "heat",  "meter": "kamheat",  "meter_datetime":
// "2024-01-15 11:46",  "name": "Kamstrup_MC603_mbus",  "on_time_at_error_h": 28,  "on_time_h": 17232,  "power_kw": 560,
// "return_energy_m3c": 37929,  "status": "OK",  "t1_temperature_c": 81.37,  "t2_temperature_c": 44.31,  "target_date":
// "2024-01-01",  "target_energy_kwh": 3200000,  "target_volume_m3": 81847,  "timestamp": "1111-11-11T11:11:11Z",
// "total_energy_consumption_kwh": 3363200,  "total_volume_m3": 85656,  "volume_flow_m3h": 13.16}
...
// {"id": "85412440","media": "heat","meter": "kamheat","meter_date": "2024-04-05","name": "KMHEAT","power_kw":
// 185,"status": "OK","t1_temperature_c": 75.8,"t2_temperature_c": 37.6,"target_date": "2024-04-01","target_energy_kwh":
// 0,"timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 5277.777778,"total_volume_m3":
// 117,"volume_flow_m3h": 4.19} |KMHEAT;85412440;5277.777778;117;OK;1111-11-11 11:11.11
...
// "85007420","max_flow_m3h": 0.096,"max_power_kw": 0.8,"media": "heat volume at inlet","meter":
// "kamheat","meter_datetime": "2024-08-02 12:13","name": "KM2","on_time_at_error_h": 10,"on_time_h": 10632,"power_kw":
// 0,"return_energy_m3c": 4429,"status": "OK","t1_temperature_c": 44.85,"t2_temperature_c": 42.67,"target_date":
// "2024-01-01","timestamp": "1111-11-11T11:11:11Z","total_energy_consumption_kwh": 33861.111111,"total_volume_m3":
// 1075,"volume_flow_m3h": 0} |KM2;85007420;33861.111111;1075;OK;1111-11-11 11:11.11
