...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor(
      "target", "The total water consumption recorded at the end of previous billing period.", DEFAULT_PRINT_PROPERTIES,
  ...
  addStringFieldWithExtractor(
      "target_date", "Date when previous billing period ended.", DEFAULT_PRINT_PROPERTIES,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Date).set(StorageNr(1)));

  addStringFieldWithExtractorAndLookup("unknown_a", "Unknown flags.", DEFAULT_PRINT_PROPERTIES,
                                       FieldMatcher::build().set(DifVifKey("047F")),
                                       {
                                           {
                                               {"WOOTA",
                                                Translate::MapType::BitToString,
  ...
  addStringFieldWithExtractorAndLookup("unknown_b", "Unknown flags.", DEFAULT_PRINT_PROPERTIES,
                                       FieldMatcher::build().set(DifVifKey("027F")),
                                       {
                                           {
                                               {"WOOTB",
                                                Translate::MapType::BitToString,
...
// {"media":"water","meter":"itron","name":"SomeWater","id":"12345698","enhanced_id":"002108728367","meter_datetime":"2022-01-21
// 01:26:44","total_m3":4.605,"status":"OK","target_m3":3.888,"target_date":"2021-12-31","unknown_a":"WOOTA_C060000","unknown_b":"WOOTB_2A86","timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"water","meter":"itron","name":"MoreWater","id":"18000056","meter_datetime":"2022-10-08
// 21:16:14","total_m3":521.277,"total_backward_m3":0,"volume_flow_m3h":0.004,"status":"OK","target_m3":520.461,"target_date":"2022-10-01","timestamp":"1111-11-11T11:11:11Z"}
...
// {"enhanced_id": "000000000000","id": "20310959","media": "water","meter": "itron","meter_datetime": "2023-07-20
// 21:18:16","name": "AnyWater","status": "OK","target_date": "2022-12-31","target_m3": 87.98,"timestamp":
// "1111-11-11T11:11:11Z","total_m3": 111.968,"unknown_a": "WOOTA_C060000","unknown_b": "WOOTB_2A6C"}
...
// {"enhanced_id": "002300037118", "id": "23362098", "media": "cold water", "meter": "itron", "meter_datetime":
// "2023-11-01 13:38:03", "name": "ColdWaterMeter", "status": "OK", "target_date": "2000-01-31", "timestamp":
// "1111-11-11T11:11:11Z", "total_m3": 4.142,"unknown_a": "WOOTA_C060016","unknown_b": "WOOTB_2A9A" }
