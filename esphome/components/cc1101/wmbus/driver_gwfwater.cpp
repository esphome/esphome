...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringField("status", "Meter status.", PrintProperty::INCLUDE_TPL_STATUS | PrintProperty::STATUS);

  addStringField("mfct_status", "Mfct status bit.", PrintProperty::INJECT_INTO_STATUS | PrintProperty::HIDE);

  addStringField("power_mode", "Normal or saving.", DEFAULT_PRINT_PROPERTIES);

  addNumericField("battery", Quantity::Time, DEFAULT_PRINT_PROPERTIES, "Remaining battery life in years.", Unit::Year);
}
...
// {"actuality_duration_s": 16,"battery_y": 0,"id": "20221031","media": "bus/system component","meter":
// "gwfwater","name": "Wateroo","power_mode": "SAVING","status": "BATTERY_LOW POWER_LOW","target_date":
// "2128-03-31","target_m3": -0.001,"timestamp": "1111-11-11T11:11:11Z","total_m3": 0.062}
