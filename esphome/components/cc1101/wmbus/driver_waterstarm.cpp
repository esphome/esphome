...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor("meter", "Device date time.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime,
  ...
  addNumericFieldWithExtractor("total_backwards", "The total backward water volume recorded by this meter.",
  ...
  addNumericFieldWithExtractor("battery", "The battery voltage.", DEFAULT_PRINT_PROPERTIES, Quantity::Voltage,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Voltage));

  addNumericFieldWithExtractor(
      "set", "The most recent billing period date.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto,
  ...
  addNumericFieldWithExtractor(
      "consumption_at_history_{storage_counter - 1 counter}", "The total water consumption at the historic date.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Volume, VifScaling::Auto, DifSignedness::Signed,
...
// 10:40","total_m3":0.106,"total_backwards_m3":0,"current_status":"LEAKAGE_OR_NO_USAGE
// POWER_LOW","status":"LEAKAGE_OR_NO_USAGE
// POWER_LOW","meter_version":"000008","parameter_set":"1100","timestamp":"1111-11-11T11:11:11Z"}
...
// 13:57","name":"ColdLorenz","set_date":"2021-12-31","timestamp":"1111-11-11T11:11:11Z","total_m3":6.8}
