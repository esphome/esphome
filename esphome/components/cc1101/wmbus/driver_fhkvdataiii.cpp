...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringField("current_date", "Date of current billing period.", DEFAULT_PRINT_PROPERTIES);

  addNumericField("previous", Quantity::HCA, DEFAULT_PRINT_PROPERTIES,
                  "Energy consumption in previous billing period.");

  addStringField("previous_date", "Date of last billing period.", DEFAULT_PRINT_PROPERTIES);

  addNumericField("temp_room", Quantity::Temperature, DEFAULT_PRINT_PROPERTIES, "Current room temperature.");

  addNumericField("temp_radiator", Quantity::Temperature, DEFAULT_PRINT_PROPERTIES, "Current radiator temperature.");
}
...
void Driver::processContent(Telegram *t) {
  ...
  string previous_date = std::to_string(year_prev) + "-" + leadingZeroString(month_prev) + "-" +
  ...
  t->addSpecialExplanation(t->header_size + 1, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(),
                           previous_date.c_str());
  ...
  t->addSpecialExplanation(t->header_size + 3, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(), previous_hca);
  ...
  string current_date = std::to_string(year_curr) + "-" + leadingZeroString(month_curr) + "-" +
  ...
  t->addSpecialExplanation(t->header_size + 5, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(),
                           current_date.c_str());
  ...
  t->addSpecialExplanation(t->header_size + 7, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(), current_hca);
  ...
  t->addSpecialExplanation(t->header_size + offset, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(),
                           temp_room_c);
  ...
  t->addSpecialExplanation(t->header_size + offset + 2, 2, KindOfData::CONTENT, Understanding::FULL, info.c_str(),
                           temp_radiator_c);
}
...
// {"media":"heat cost
// allocator","meter":"fhkvdataiii","name":"Room","id":"11776622","current_hca":131,"current_date":"2020-02-08T02:00:00Z","previous_hca":1026,"previous_date":"2019-12-31T02:00:00Z","temp_room_c":22.44,"temp_radiator_c":25.51,"timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"heat cost
// allocator","meter":"fhkvdataiii","name":"Rooom","id":"11111234","current_hca":4,"current_date":"2021-02-05T02:00:00Z","previous_hca":45,"previous_date":"2020-12-31T02:00:00Z","temp_room_c":22.37,"temp_radiator_c":23.6,"timestamp":"1111-11-11T11:11:11Z"}
