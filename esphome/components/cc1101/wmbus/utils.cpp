...
std::string format_hex_pretty(std::vector<unsigned char> data) { return format_hex_pretty(data.data(), data.size()); }
...
bool hex2bin(const std::string &src, std::vector<uchar> *target) { return hex2bin(src.c_str(), target); }
...
bool startsWith(const std::string &s, std::string &prefix) { return startsWith(s, prefix.c_str()); }
...
std::string eatToSkipWhitespace(std::vector<uchar> &v, std::vector<uchar>::iterator &i, int c, size_t max, bool *eof,
                                bool *err) {
...
std::string currentYear() { return std::string("2000"); }

std::string currentDay() { return std::string("2000-01-01"); }

std::string currentHour() { return std::string("2000-01-01_00"); }

std::string currentMinute() { return std::string("2000-01-01_00:00"); }

std::string currentSeconds() { return std::string("2000-01-01_00:00:00"); }

std::string currentMicros() { return std::string("2000-01-01_00:00"); }
