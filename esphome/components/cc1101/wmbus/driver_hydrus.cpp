...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addStringField("status", "Status of meter.", PrintProperty::STATUS | PrintProperty::INCLUDE_TPL_STATUS);
  ...
  addNumericFieldWithExtractor(
      "total_tariff{tariff_counter}", "The total water consumption recorded on tariff # by this meter.",
      DEFAULT_PRINT_PROPERTIES, Quantity::Volume, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Volume).set(TariffNr(1), TariffNr(2)));

  addNumericFieldWithExtractor("total_tariff{tariff_counter}_at_date",
  ...
  addNumericFieldWithExtractor("flow", "The current water flow.", DEFAULT_PRINT_PROPERTIES, Quantity::Flow,
                               VifScaling::Auto, DifSignedness::Signed,
                               FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::VolumeFlow));

  addNumericFieldWithExtractor(
      "total_at_date", "The total water consumption recorded at date.", DEFAULT_PRINT_PROPERTIES, Quantity::Volume,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Volume).set(StorageNr(1)));

  addNumericFieldWithExtractor(
      "at", "The last billing period date.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto,
      DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Date).set(StorageNr(1)), Unit::DateLT);

  addNumericFieldWithExtractor(
      "target", "The total water consumption recorded at the end of last month.", DEFAULT_PRINT_PROPERTIES,
      Quantity::Volume, VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::Volume).set(StorageNr(3)));

  addNumericFieldWithExtractor(
      "target", "The end of last month.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto,
      DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::DateTime).set(StorageNr(3)));

  addNumericFieldWithExtractor(
      "remaining_battery_life", "Remaining battery life in years.", DEFAULT_PRINT_PROPERTIES, Quantity::Time,
      VifScaling::Auto, DifSignedness::Signed,
      FieldMatcher::build().set(MeasurementType::Instantaneous).set(VIFRange::RemainingBattery), Unit::Year);
}
}  // namespace
...
// {"media":"water","meter":"hydrus","name":"HydrusWater","id":"64646464","total_m3":1.174,"flow_m3h":0,"flow_temperature_c":10.4,"remaining_battery_life_y":13.686797,"status":"OK","target_datetime":"2019-10-31
// 23:59","target_m3": 0.2,"timestamp":"1111-11-11T11:11:11Z"} |HydrusWater;64646464;1.174;null;OK;1111-11-11 11:11.11
...
// {"media":"warm water","meter":"hydrus","name":"HydrusVater","id":"65656565","flow_m3h":0,"customer":
// "A20B410178","total_m3":3.45,"remaining_battery_life_y":15.321328,"target_datetime":"2020-09-13
// 23:59","target_m3": 3.431,"status":"OK","timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"water","meter":"hydrus","name":"HydrusIzarRS","id":"60897379","total_m3":71.442,"at_date":
// "2021-03-31","total_at_date_m3":69.7,"status":"OK","timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"warm
// water","meter":"hydrus","name":"HydrusIzarRSWarm","id":"60904720","total_m3":49.373,"total_at_date_m3":48.002,"at_date":"2021-03-31","status":"OK","timestamp":"1111-11-11T11:11:11Z"}
...
// {"at_date": "2022-12-31","target_datetime": "2023-09-30 23:59","flow_m3h": -0.002,"flow_temperature_c": 19.3,"id":
// "64641820","media": "water","meter": "hydrus","name": "HydrusFoo","remaining_battery_life_y": 9.240436,"status":
// "OK","timestamp": "1111-11-11T11:11:11Z","total_at_date_m3":244.623,"target_m3": 294.128,"total_m3":
// 296.789,"total_tariff1_at_date_m3": 0,"total_tariff2_at_date_m3": 244.623}
