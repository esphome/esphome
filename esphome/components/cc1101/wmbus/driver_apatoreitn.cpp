...
static bool ok = registerDriver([](DriverInfo &di) {
  ...
  di.setDefaultFields("name,id,current_hca,previous_hca,current_date,season_start_date,esb_date,temp_room_avg_c,temp_"
                      "room_prev_avg_c,timestamp");
...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  addNumericField("current", Quantity::HCA, DEFAULT_PRINT_PROPERTIES,
                  "Energy consumption so far in this billing period.");

  addNumericField("previous", Quantity::HCA, DEFAULT_PRINT_PROPERTIES,
                  "Energy consumption in previous billing period.");

  addStringField("current_date", "Current date, as reported by meter.", DEFAULT_PRINT_PROPERTIES);

  addStringField("season_start_date", "Season start date.", DEFAULT_PRINT_PROPERTIES);

  addStringField("esb_date", "Electronic seal protection break date.", DEFAULT_PRINT_PROPERTIES);

  addNumericField("temp_room_avg", Quantity::Temperature, DEFAULT_PRINT_PROPERTIES,
                  "Average room temperature in current season.");

  addNumericField("temp_room_prev_avg", Quantity::Temperature, DEFAULT_PRINT_PROPERTIES,
...
// {"media":"heat cost
// allocation","meter":"apatoreitn","name":"HCA1","id":"37373731","current_hca":1,"previous_hca":89,"current_date":"2022-09-18T02:00:00Z","season_start_date":"2016-05-01T02:00:00Z","esb_date":"2019-08-28T02:00:00Z","temp_room_avg_c":21.703125,"temp_room_prev_avg_c":19.890625,"timestamp":"1111-11-11T11:11:11Z"}
// |HCA1;37373731;1;89;2022-09-18T02:00:00Z;2016-05-01T02:00:00Z;2019-08-28T02:00:00Z;21.703125;19.890625;1111-11-11
// 11:11.11

// Test: HCA2 apatoreitn 37373732 NOKEY
// telegram=|25441486323737370408B60AFFFFF5450186F41B9D58A0A100007809000000001F2D6416C819|
// {"media":"heat cost
// allocation","meter":"apatoreitn","name":"HCA2","id":"37373732","current_hca":0,"previous_hca":2424,"current_date":"2022-08-31T02:00:00Z","season_start_date":"2016-05-01T02:00:00Z","esb_date":"","temp_room_avg_c":25.78125,"temp_room_prev_avg_c":22.390625,"timestamp":"1111-11-11T11:11:11Z"}
...
// {"media":"heat cost
// allocation","meter":"apatoreitn","name":"HCA3","id":"37373733","current_hca":1,"previous_hca":89,"current_date":"2022-09-18T02:00:00Z","season_start_date":"2016-05-01T02:00:00Z","esb_date":"2018-12-28T02:00:00Z","temp_room_avg_c":21.703125,"temp_room_prev_avg_c":19.890625,"timestamp":"1111-11-11T11:11:11Z"}
// |HCA3;37373733;1;89;2022-09-18T02:00:00Z;2016-05-01T02:00:00Z;2018-12-28T02:00:00Z;21.703125;19.890625;1111-11-11
// 11:11.11
