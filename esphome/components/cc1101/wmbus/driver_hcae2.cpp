...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor("consumption_at_set_date_{storage_counter}", "The heat cost allocation at set date #.",
  ...
  addNumericFieldWithExtractor(
      "consumption_at_set_date", "Deprecated field.", DEFAULT_PRINT_PROPERTIES, Quantity::HCA, VifScaling::Auto,
