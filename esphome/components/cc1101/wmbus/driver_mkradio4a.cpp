...
Driver::Driver(MeterInfo &mi, DriverInfo &di) : MeterCommonImplementation(mi, di) {
  ...
  addNumericFieldWithExtractor(
      "target", "The total water consumption recorded at the end of previous year.", DEFAULT_PRINT_PROPERTIES,
  ...
  addNumericFieldWithExtractor(
      "target", "Date when previous year ended.", DEFAULT_PRINT_PROPERTIES, Quantity::PointInTime, VifScaling::Auto,
...
// {"media":"warm
// water","meter":"mkradio4a","name":"FOO","id":"66953825","target_m3":16.1,"target_date":"2021-12-31","timestamp":"1111-11-11T11:11:11Z"}
