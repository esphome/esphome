...
// First eat whitespace, then start eating until c is found or eof. The found string is trimmed from beginning and
// ending whitespace.
std::string eatToSkipWhitespace(std::vector<char> &v, std::vector<char>::iterator &i, int c, size_t max, bool *eof,
                                bool *err);
...
#define warning(fmt, ...) warning_x(__FILENAME__, __LINE__, fmt, ##__VA_ARGS__)
#define error(fmt, ...) error_x(__FILENAME__, __LINE__, fmt, ##__VA_ARGS__)
#define debug(fmt, ...) verbose_x(__FILENAME__, __LINE__, fmt, ##__VA_ARGS__)
#define verbose(fmt, ...) debug_x(__FILENAME__, __LINE__, fmt, ##__VA_ARGS__)
#define trace(fmt, ...) trace_x(__FILENAME__, __LINE__, fmt, ##__VA_ARGS__)
