...
enum TXPOWER
{
	POWER_MIN = 0,              // Minimum power
	POWER_0db,                  // 0dBm power
 ...
 * PATABLE values
 **/
#define PA_MinPower_315				0x12	// -30dBm
#define PA_MinPower_433				0x12	// -30dBm
#define PA_MinPower_868				0x03	// -30dBm
#define PA_MinPower_915				0x03	// -30dBm

#define PA_0dbPower_315				0x51	// 0dBm
#define PA_0dbPower_433				0x60	// 0dBm
#define PA_0dbPower_868				0x50	// 0dBm
#define PA_0dbPower_915				0x8E	// 0dBm

#define PA_MaxPower_315				0xC2	// 26.9dBm
#define PA_MaxPower_433				0xC0	// 29.1dBm
#define PA_MaxPower_868				0xC2	// 32.4dBm
#define PA_MaxPower_915				0xC0	// 31.8dBm
