...
class CC1101Component : public Component,
 ...
 public:
  ...
  /// Software-tracked flag indicating a transmission is in progress.  Used by ir_rf_proxy
  /// to suppress ghost RX events generated by the MCU driving the shared GDO0 pin while
  /// the chip is in TX state.  The CC1101 itself does not touch this — it's purely a
  /// coordination flag between cooperating components.
  void set_tx_busy(bool busy) { this->tx_busy_ = busy; }
  bool is_tx_busy() const { return this->tx_busy_; }
 ...
 protected:
  ...
  // Coordination flag — see set_tx_busy() docstring above
  bool tx_busy_{false};
