...
def set_sdkconfig_options(config: ConfigType) -> None:
    ...
    # The DNS64 hook breaks IPv6 literal lookups; see openthread_esp.cpp. libsrc.a is
    # scanned before the IDF libraries, so --undefined pulls the wrapper in.
    cg.add_build_flag("-Wl,--wrap=lwip_hook_dns_external_resolve")
    cg.add_build_flag("-Wl,--undefined=__wrap_lwip_hook_dns_external_resolve")
