...
WifiNowPeer::WifiNowPeer() : sequenceno_{0} {}
...
void WifiNowPeer::set_sequenceno(uint32_t sequenceno) { this->sequenceno_ = sequenceno; }

uint32_t WifiNowPeer::get_sequenceno() { return this->sequenceno_; }
