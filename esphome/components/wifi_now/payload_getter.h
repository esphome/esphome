...
template<typename... Ts> class WifiNowPayloadGetter {
 public:
  WifiNowPayloadGetter() {}
  virtual void get_payload(payload_t &payload, Ts... x) = 0;
};

template<typename T, typename... Ts> class WifiNowTemplatePayloadGetter : public WifiNowPayloadGetter<Ts...> {
...
template<typename... Ts> class WifiNowTemplatePayloadGetter<std::string, Ts...> : public WifiNowPayloadGetter<Ts...> {
...
class WifiNowTemplatePayloadGetter<std::vector<uint8_t>, Ts...> : public WifiNowPayloadGetter<Ts...> {
...
template<typename... Ts> class WifiNowTemplatePayloadGetter<bool, Ts...> : public WifiNowPayloadGetter<Ts...> {
...
template<typename... Ts> class WifiNowPayloadPayloadGetter : public WifiNowPayloadGetter<Ts...> {
