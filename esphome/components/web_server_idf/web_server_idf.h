...
class AsyncEventSourceResponse {
 ...
 protected:
  ...
  // Stack arena for a state document, one ArduinoJson pool plus room for copied string nodes
  // (2176 bytes on 32 bit targets); a 40 option select fits, anything larger spills to the heap
