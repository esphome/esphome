...
from esphome.const import (
    CONF_ID, CONF_PM_1_0, CONF_PM_2_5, CONF_PM_4_0, CONF_PM_10_0, CONF_PM_SIZE, CONF_PMC_0_5,
    CONF_PMC_1_0, CONF_PMC_2_5, CONF_PMC_4_0, CONF_PMC_10_0, ICON_CHEMICAL_WEAPON, ICON_COUNTER,
    ICON_RULER, UNIT_COUNTS_PER_CUBIC_METER, UNIT_MICROGRAMS_PER_CUBIC_METER, UNIT_MICROMETER,
)
