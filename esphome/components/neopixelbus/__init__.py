...
from esphome.const import CONF_CLOCK_PIN, CONF_DATA_PIN, CONF_METHOD, CONF_NAME, \
    CONF_NUM_LEDS, CONF_PIN, CONF_POWER_SUPPLY, CONF_TYPE, CONF_VARIANT, CONF_OUTPUT_ID
...
def to_code(config):
    ...
    rhs = out_type.new(config[CONF_NAME])
    ...
    if CONF_POWER_SUPPLY in config:
        ...
        cg.add(var_.set_power_supply(power_supply))
