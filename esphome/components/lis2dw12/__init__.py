...
lis2dw12_ns = cg.esphome_ns.namespace("lis2dw12")
LIS2DW12Component = lis2dw12_ns.class_(
    "LIS2DW12Component", cg.PollingComponent, i2c.I2CDevice
)

LIS2DW12Range = lis2dw12_ns.enum("Range", True)
RANGES = {
...
LIS2DW12PowerMode = lis2dw12_ns.enum("PowerMode", True)
POWER_MODES = {
...
LIS2DW12DataRate = lis2dw12_ns.enum("DataRate", True)
DATA_RATES = {
...
LIS2DW12FilterBandwidth = lis2dw12_ns.enum("FilterBandwidth", True)
FILTER_BANDWIDTHS = {
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_DATA_RATE, default="100Hz"): cv.enum(DATA_RATES),
...
async def to_code(config):
    ...
    cg.add(var.set_data_rate(DATA_RATES[config[CONF_DATA_RATE]]))
