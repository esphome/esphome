...
# 32-48), gpio2 (ngpios=<11>, flat 64-74). Free-mux via NRF_PSEL, shared by
# every free-mux GPIO signal (UART, SPI).
_GPIO_MATRIX_PINS = (
    frozenset(range(7)) | frozenset(range(32, 49)) | frozenset(range(64, 75))
)
