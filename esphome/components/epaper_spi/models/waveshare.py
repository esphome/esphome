...
EpaperModel(
    ...
    width=800,
    height=480,
    minimum_update_interval="180s",
    initsequence=(
        (20, 0xFF),  # initial settle delay, best-effort
        (0x18, 0x80),  # temperature sensor / internal sensor
        (0x0C, 0xAE, 0xC7, 0xC3, 0xC0, 0x80),  # soft-start / booster
        (0x01, 0xDF, 0x01, 0x02),  # driver output control: 479 lines, scan config
        (0x3C, 0x01),  # border waveform
        (0x11, 0x01),  # data entry mode
        (0x44, 0x00, 0x00, 0x1F, 0x03),  # RAM X start/end: 0..799
        (0x45, 0xDF, 0x01, 0x00, 0x00),  # RAM Y start/end: 479..0
        (0x4E, 0x00, 0x00),  # RAM X counter
