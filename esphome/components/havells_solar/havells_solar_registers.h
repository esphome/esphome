...
static const uint16_t HAVELLS_PV1_VOLTAGE_SAMPLED_BY_SLAVE_CPU  = 0x001E;
static const uint16_t HAVELLS_PV2_VOLTAGE_SAMPLED_BY_SLAVE_CPU  = 0x001F;
static const uint16_t HAVELLS_INSULATION_OF_PV1_P_TO_GROUND     = 0x0024;
static const uint16_t HAVELLS_INSULATION_OF_PV2_P_TO_GROUND     = 0x0025;
