...
#if !defined(USE_ESP32) && defined(USE_ARDUINO) && defined(USE_WEBSERVER_EVENTS)
...
#ifdef defined(USE_ESP32) && defined(USE_WEBSERVER_EVENTS)
...
#ifdef USE_WEBSERVER_EVENTS
    this->events_.try_send_nodefer("", "ping", millis(), 30000);
#endif
  });
}
void WebServer::loop() {
...
bool WebServer::canHandle(AsyncWebServerRequest *request) const {
  ...
  static const char *const STATIC_URLS[] = {
    ...
    "/events",
#endif
#ifdef defined(USE_WEBSERVER_CSS_INCLUDE) && !defined(USE_WEBSERVER_GUI_DISABLED)
    "/0.css",
#endif
#ifdef defined(USE_WEBSERVER_JS_INCLUDE) && !defined(USE_WEBSERVER_GUI_DISABLED)
    "/0.js",
#endif
  };
