...
static const char *TAG = "xiaomi_xmtzc1xhm";

void XiaomiXMTZC1XHM::dump_config() {
  ESP_LOGCONFIG(TAG, "Xiaomi XMTZC1XHM");
  LOG_SENSOR("  ", "Measured Weight", this->weight_);
  LOG_SENSOR("  ", "Measured Impedance", this->impedance_);
}

bool XiaomiXMTZC1XHM::parse_device(const esp32_ble_tracker::ESPBTDevice &device) {
