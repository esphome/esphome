...
void ESP32RMTLEDStripLightOutput::setup() {
  ...
  RAMAllocator<uint8_t> allocator(RAMAllocator<uint8_t>::ALLOW_FAILURE | (this->use_psram_?0:RAMAllocator<uint8_t>::ALLOC_INTERNAL) );
  ...
  RAMAllocator<rmt_item32_t> rmt_allocator(RAMAllocator<rmt_item32_t>::ALLOW_FAILURE | (this->use_psram_?0:RAMAllocator<rmt_item32_t>::ALLOC_INTERNAL));
