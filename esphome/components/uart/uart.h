...
class UARTDevice {
 public:
  ...
  void set_debug_prefix(std::string debug_prefix) { this->parent_->set_debug_prefix(debug_prefix); }
  void set_debug_add_settings(bool add_settings) { this->parent_->set_debug_add_settings(add_settings); }
#endif
