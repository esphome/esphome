...
void RP2UartComponent::dump_config() {
...
void RP2UartComponent::write_array(const uint8_t *data, size_t len) {
...
bool RP2UartComponent::peek_byte(uint8_t *data) {
  if (!this->check_read_timeout_())
    return false;
  *data = this->serial_->peek();
  return true;
}
bool RP2UartComponent::read_array(uint8_t *data, size_t len) {
...
size_t RP2UartComponent::available() { return this->serial_->available(); }
UARTFlushResult RP2UartComponent::flush() {
