"""Feedback component — FeedbackActuatorBase and shared schema."""
...
feedback_ns = cg.esphome_ns.namespace("feedback")
...
FEEDBACK_ACTUATOR_SCHEMA = cv.Schema(
    {
...
# Cross-field validators to apply on the full assembled schema (via cv.All) — kept separate
# because cv.Schema.extend() can't chain through a cv.All wrapper.
...
async def apply_feedback_actuator_config(var, config):
    # STOP
