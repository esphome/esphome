...
#endif
#if (defined(USE_RP2) || defined(USE_ZEPHYR)) && defined(USE_MDNS_EVENT_DRIVEN_POLLING)
  // RP2040 and Zephyr both defer registration until the first IP-up event; this tracks that.
