...
//   TFLM_OP_CONDITIONAL(BuiltinOperator_suffix, snake)     -> registered only when the resolver has the AddMethod
...
TFLM_OP_CONDITIONAL(DYNAMIC_UPDATE_SLICE, dynamic_update_slice)

// ====== Reduction Ops ======
TFLM_OP_AVAILABLE(REDUCE_MAX, AddReduceMax)
TFLM_OP_CONDITIONAL(REDUCE_MIN, reduce_min)
TFLM_OP_CONDITIONAL(REDUCE_ALL, reduce_all)
...
TFLM_OP_CONDITIONAL(REVERSE_V2, reverse_v2)
