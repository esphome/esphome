...
from esphome.const import (
    CONF_BUS_VOLTAGE, CONF_CURRENT, CONF_ID, CONF_MAX_CURRENT, CONF_MAX_VOLTAGE, CONF_POWER,
    CONF_SHUNT_RESISTANCE, CONF_SHUNT_VOLTAGE, ICON_FLASH, UNIT_AMPERE, UNIT_VOLT, UNIT_WATT,
)
