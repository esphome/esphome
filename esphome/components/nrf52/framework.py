...
def check_and_install(zigbee: bool = False) -> None:
    ...
    if not sentinel.exists():
        ...
        with tempfile.NamedTemporaryFile() as tmp:
            ...
            # SDK 1.0.1's CMake scripts (cmake/zephyr/gnu/generic.cmake) glob for the
            # cross-compiler under $ZEPHYR_SDK_INSTALL_DIR/gnu/*-*zephyr-*, not flat at
            # the toolchain root as the pre-1.0 SDK generation expected.
            archive_extract_all(
                tmp.file,
