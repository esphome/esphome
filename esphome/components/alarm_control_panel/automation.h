...
template<typename... Ts> class AlarmControlPanelIsArmedCondition final : public Condition<Ts...> {
 public:
...
class AlarmControlPanelDesiredStateCondition final : public Condition<Ts...> {
 public:
