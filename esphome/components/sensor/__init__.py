...
from esphome.const import CONF_DEVICE_CLASS, CONF_ABOVE, CONF_ACCURACY_DECIMALS, CONF_ALPHA, \
    ...
    DEVICE_CLASS_POWER_FACTOR, DEVICE_CLASS_PRESSURE, DEVICE_CLASS_TIMESTAMP, \
    DEVICE_CLASS_VOLTAGE, DEVICE_CLASS_MEMORY, DEVICE_CLASS_ESPHOME
...
DEVICE_CLASSES = [
    ...
    DEVICE_CLASS_TIMESTAMP, DEVICE_CLASS_VOLTAGE, DEVICE_CLASS_MEMORY, DEVICE_CLASS_ESPHOME
]
