...
from esphome.const import CONF_DEVICE_CLASS, CONF_ABOVE, CONF_ACCURACY_DECIMALS, CONF_ALPHA, \
    ...
    CONF_FORCE_UPDATE, DEVICE_CLASS_NONE, DEVICE_CLASS_BATTERY, DEVICE_CLASS_CURRENT, \
...
DEVICE_CLASSES = [
    DEVICE_CLASS_NONE, DEVICE_CLASS_BATTERY, DEVICE_CLASS_CURRENT, DEVICE_CLASS_ENERGY,
...
def sensor_schema(unit_of_measurement_, icon_, accuracy_decimals_, device_class_=DEVICE_CLASS_NONE):
