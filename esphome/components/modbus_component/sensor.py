...
from esphome.components import sensor, modbus, binary_sensor, modbus_component
...
AUTO_LOAD = ["modbus", "binary_sensor", "status", "modbus_component"]
...
SENSOR_VALUE_TYPE = {
    ...
    "S_DOUBLE_HILO": SensorValueType.S_DOUBLE_HILO,
}
