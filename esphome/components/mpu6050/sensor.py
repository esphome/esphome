...
from esphome.const import (
    CONF_ID, CONF_TEMPERATURE, ICON_BRIEFCASE_DOWNLOAD, ICON_SCREEN_ROTATION, ICON_THERMOMETER,
    UNIT_CELSIUS, UNIT_DEGREE_PER_SECOND, UNIT_METER_PER_SECOND_SQUARED,
)
