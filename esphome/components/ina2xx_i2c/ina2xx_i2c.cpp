...
bool INA2XXI2C::read_ina_register(uint8_t a_register, uint8_t *data, size_t len) {
...
bool INA2XXI2C::write_ina_register(uint8_t a_register, const uint8_t *data, size_t len) {
