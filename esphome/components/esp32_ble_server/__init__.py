...
def final_validate_config(config):
    # Create the device information service first
    # (must be at final validation to avoid conflicts generated by CORE.raw_config)
    create_device_information_service(config)
