#include "inkbird_ibsth2.h"
#include "esphome/core/log.h"

#ifdef USE_ESP32

namespace esphome {
namespace inkbird_ibsth2 {

static const char *const TAG = "inkbird_ibsth2";

void InkbirdIbstH2::dump_config() {
  ESP_LOGCONFIG(TAG, "Inkbird IBS TH2");
  LOG_SENSOR("  ", "Temperature", this->temperature_);
  LOG_SENSOR("  ", "Humidity", this->humidity_);
  LOG_SENSOR("  ", "Battery Level", this->battery_level_);
}

bool InkbirdIbstH2::parse_device(const esp32_ble_tracker::ESPBTDevice &device) {
  ...
  // for Inkbird IBS-TH2 device we expect
