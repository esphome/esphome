...
# QPIRI sensors
    cv.Optional(CONF_GRID_RATING_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_GRID_RATING_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_RATING_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_RATING_FREQUENCY ):
        sensor.sensor_schema(UNIT_HERTZ, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_RATING_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_RATING_APPARENT_POWER ):
        sensor.sensor_schema(UNIT_VOLT_AMPS, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_RATING_ACTIVE_POWER ):
        sensor.sensor_schema(UNIT_WATT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_RATING_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_RECHARGE_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_UNDER_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_BULK_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_FLOAT_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_TYPE ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_CURRENT_MAX_AC_CHARGING_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_CURRENT_MAX_CHARGING_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_INPUT_VOLTAGE_RANGE ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_OUTPUT_SOURCE_PRIORITY ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_CHARGER_SOURCE_PRIORITY ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PARALLEL_MAX_NUM ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_MACHINE_TYPE ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_TOPOLOGY ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_OUTPUT_MODE ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_REDISCHARGE_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PV_OK_CONDITION_FOR_PARALLEL ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PV_POWER_BALANCE ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
# QPIGS sensors
    cv.Optional(CONF_GRID_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_GRID_FREQUENCY ):
        sensor.sensor_schema(UNIT_HERTZ, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_FREQUENCY ):
        sensor.sensor_schema(UNIT_HERTZ, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_APPARENT_POWER ):
        sensor.sensor_schema(UNIT_VOLT_AMPS, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_AC_OUTPUT_ACTIVE_POWER ):
        sensor.sensor_schema(UNIT_WATT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_OUTPUT_LOAD_PERCENT ):
        sensor.sensor_schema(UNIT_PERCENT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BUS_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_CHARGING_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_CAPACITY_PERCENT ):
        sensor.sensor_schema(UNIT_PERCENT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_INVERTER_HEAT_SINK_TEMPERATURE ):
        sensor.sensor_schema(UNIT_CELSIUS, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PV_INPUT_CURRENT_FOR_BATTERY ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PV_INPUT_VOLTAGE ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_VOLTAGE_SCC ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_DISCHARGE_CURRENT ):
        sensor.sensor_schema(UNIT_AMPERE, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_BATTERY_VOLTAGE_OFFSET_FOR_FANS_ON ):
        sensor.sensor_schema(UNIT_VOLT, ICON_EMPTY, 1, DEVICE_CLASS_POWER), 
    cv.Optional(CONF_EEPROM_VERSION ):
        sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1, DEVICE_CLASS_POWER),
    cv.Optional(CONF_PV_CHARGING_POWER ):
        sensor.sensor_schema(UNIT_WATT, ICON_EMPTY, 1, DEVICE_CLASS_POWER)       
    })
