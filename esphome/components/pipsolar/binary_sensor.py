...
CONF_WARNING_HIGH_AC_INPUT_DURING_BUS_SOFT_START = 'warning_high_ac_input_during_bus_soft_start';
...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Optional(CONF_FAULT_INVERTER_VOLTAGE_TOO_LOW): binary_sensor.BINARY_SENSOR_SCHEMA,
    cv.Optional(CONF_FAULT_INVERTER_VOLTAGE_TOO_HIGH): binary_sensor.BINARY_SENSOR_SCHEMA,
    ...
    cv.Optional(CONF_WARNING_BATTERY_VOLTAGE_HIGH): binary_sensor.BINARY_SENSOR_SCHEMA,
    cv.Optional(CONF_WARNING_BATTERY_LOW_ALARM): binary_sensor.BINARY_SENSOR_SCHEMA,
    cv.Optional(CONF_WARNING_BATTERY_UNDER_SHUTDOWN): binary_sensor.BINARY_SENSOR_SCHEMA,
    ...
    cv.Optional(CONF_FAULT_INVERTER_OVER_CURRENT): binary_sensor.BINARY_SENSOR_SCHEMA,
    cv.Optional(CONF_FAULT_INVERTER_SOFT_FAILED): binary_sensor.BINARY_SENSOR_SCHEMA,
    ...
    cv.Optional(CONF_FAULT_CURRENT_SENSOR_FAILED): binary_sensor.BINARY_SENSOR_SCHEMA,
    ...
    cv.Optional(CONF_WARNING_BATTERY_TOO_LOW_TO_CHARGE): binary_sensor.BINARY_SENSOR_SCHEMA,
    ...
    cv.Optional(CONF_WARNING_HIGH_AC_INPUT_DURING_BUS_SOFT_START): binary_sensor.BINARY_SENSOR_SCHEMA,
    cv.Optional(CONF_WARNING_BATTERY_EQUALIZATION): binary_sensor.BINARY_SENSOR_SCHEMA,
