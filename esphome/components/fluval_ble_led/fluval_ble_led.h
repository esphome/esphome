...
static const espbt::ESPBTUUID FLUVAL_CHARACTERISTIC_WRITE = espbt::ESPBTUUID::from_raw("00001001-0000-1000-8000-00805F9B34FB");  // notify, read, write, write no response
static const espbt::ESPBTUUID FLUVAL_CHARACTERISTIC_READ = espbt::ESPBTUUID::from_raw("00001002-0000-1000-8000-00805F9B34FB");  // notify, read
static const espbt::ESPBTUUID FLUVAL_CHARACTERISTIC_READ_REG = espbt::ESPBTUUID::from_raw("00001004-0000-1000-8000-00805F9B34FB");  //  read
static const espbt::ESPBTUUID FLUVAL_CHARACTERISTIC_WRITE_REG_ID = espbt::ESPBTUUID::from_raw("00001005-0000-1000-8000-00805F9B34FB");  // write
...
class FluvalBleLed : public esphome::ble_client::BLEClientNode, public Component {
 ...
 public:
  ...
  FluvalStatus getStatus() { return this->status_; }
