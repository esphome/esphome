...
class ATM90E32Component : public PollingComponent,
 ...
 public:
  ...
  void set_react_pow_sensor(int phase, sensor::Sensor *obj) { this->phase_[phase].react_pow_sensor_ = obj; }
  void set_pf_sensor(int phase, sensor::Sensor *obj) { this->phase_[phase].pf_sensor_ = obj; }
  void set_volt_gain(int phase, uint16_t gain) { this->phase_[phase].volt_gain_ = gain; }
  void set_ct_gain(int phase, uint16_t gain) { this->phase_[phase].ct_gain_ = gain; }

  void set_freq_sensor(sensor::Sensor *freq_sensor) { freq_sensor_ = freq_sensor; }
  void set_chip_temp_sensor(sensor::Sensor *chip_temp_sensor) { chip_temp_sensor_ = chip_temp_sensor; }
