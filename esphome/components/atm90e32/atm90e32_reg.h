...
static const uint16_t ATM90E32_STATUS_S0_TASNOLOADST = 1 << 4; // All phase arithmetic sum apparent power no-load condition status
...
static const uint16_t ATM90E32_STATUS_S1_QEREGTPST = 1 << 7;    // ReActive Energy register of all channel total sum (T) Positive Status
...
static const uint16_t ATM90E32_STATUS_S1_PEREGTPST = 1 << 3;    // Active Energy register of all channel total sum (T) Positive Status
