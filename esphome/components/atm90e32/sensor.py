...
from esphome.const import (
    CONF_CURRENT, CONF_FREQUENCY, CONF_ID, CONF_POWER, CONF_POWER_FACTOR, CONF_VOLTAGE,
    ICON_CURRENT_AC, ICON_FLASH, ICON_LIGHTBULB, ICON_THERMOMETER, UNIT_AMPERE, UNIT_CELSIUS,
    UNIT_EMPTY, UNIT_HERTZ, UNIT_VOLT, UNIT_VOLT_AMPS_REACTIVE, UNIT_WATT,
)
