    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_LATITUDE): sensor.sensor_schema(
                UNIT_DEGREES, ICON_EMPTY, 6, DEVICE_CLASS_EMPTY, STATE_CLASS_EMPTY
            ),
            ...
            cv.Optional(CONF_COURSE): sensor.sensor_schema(
                UNIT_DEGREES, ICON_EMPTY, 2, DEVICE_CLASS_EMPTY, STATE_CLASS_EMPTY
            ),
            cv.Optional(CONF_ALTITUDE): sensor.sensor_schema(
                UNIT_METER, ICON_EMPTY, 1, DEVICE_CLASS_EMPTY, STATE_CLASS_EMPTY
            ),
