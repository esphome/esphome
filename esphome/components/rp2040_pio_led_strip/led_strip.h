...
class RP2040PIOLEDStripLightOutput : public light::AddressableLight {
    public:
        ...
        light::LightTraits get_traits() override {
            ...
            this->is_rgbw_ ? traits.set_supported_color_modes({light::ColorMode::RGB, light::ColorMode::RGB_WHITE}) : traits.set_supported_color_modes({light::ColorMode::RGB});
            return traits;
        }
        ...
        void set_led_params(uint8_t, uint8_t, uint8_t, uint8_t) {}
