...
const uint8_t MAX7219_DOT_MATRIX_FONT_5[256][8] PROGMEM = {
    ...
    {0x00, 0xc0, 0xd0, 0x20, 0x40, 0xb0, 0x30, 0x00},  // '%'
    ...
    {0xc0, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  // 0xF8 degree sign
