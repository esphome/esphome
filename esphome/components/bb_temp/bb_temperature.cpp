...
//
int BBTemp::enableIRQ(int iLowTemp, int iHighTemp) {
...
//
void BBTemp::disableIRQ() {} /* disableIRQ() */
...
int BBTemp::type(void) { return _iType; } /* type() */

uint32_t BBTemp::caps(void) { return _u32Caps; } /* caps() */
