...
bool PN532::clean_iso_dep_tag_() { return this->Nfcc::clean_iso_dep_tag_(); }

bool PN532::write_iso_dep_tag_(nfc::NdefMessage *message) { return this->Nfcc::write_iso_dep_tag_(message); }
