...
from .boards import get_board_details
from .const import KEY_GPIO_CLOCK_ENABLED, KEY_STM32, KEY_UART_INSTANCES
...
def set_core_data(config):
    ...
    CORE.data[KEY_STM32].update(get_board_details(config))
