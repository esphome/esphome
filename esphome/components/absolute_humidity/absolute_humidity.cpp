...
float AbsoluteHumidityComponent::es_buck(float const temperature_c) {
  float a, b, c, d;
...
float AbsoluteHumidityComponent::es_tetens(float const temperature_c) {
  float a, b;
  if (temperature_c >= 0.0f) {
    a = 17.27f;
    b = 237.3f;
...
float AbsoluteHumidityComponent::es_wobus(float const t) {
...
float AbsoluteHumidityComponent::vapor_density(float const es, float const hr, float const ta) {
