...
from esphome.const import (
    CONF_AUTO_MODE, CONF_AWAY_CONFIG, CONF_COOL_ACTION, CONF_COOL_MODE,
    CONF_DEFAULT_TARGET_TEMPERATURE_HIGH, CONF_DEFAULT_TARGET_TEMPERATURE_LOW, CONF_DRY_ACTION,
    CONF_DRY_MODE, CONF_FAN_MODE_AUTO_ACTION, CONF_FAN_MODE_DIFFUSE_ACTION,
    CONF_FAN_MODE_FOCUS_ACTION, CONF_FAN_MODE_HIGH_ACTION, CONF_FAN_MODE_LOW_ACTION,
    CONF_FAN_MODE_MEDIUM_ACTION, CONF_FAN_MODE_MIDDLE_ACTION, CONF_FAN_MODE_OFF_ACTION,
    CONF_FAN_MODE_ON_ACTION, CONF_FAN_ONLY_ACTION, CONF_FAN_ONLY_MODE, CONF_HEAT_ACTION,
