...
class SendspinConnection {
 public:
  ...
  /// @param process_error Process noise standard deviation.
  /// @param forget_factor Forgetting factor for adaptive covariance.
  void init_time_filter(double process_error, double forget_factor);
 ...
 protected:
  ...
  double kalman_process_error_{0.0};
  double kalman_forget_factor_{1.0};
};
