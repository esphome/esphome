...
CONF_USE_ACC_ENERGY_REGS = "use_accumulated_energy_registers"
PGA_GAINS = {
    "1x": 0b000,
    "2x": 0b001,
    "4x": 0b010,
...
ADE7953_CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_USE_ACC_ENERGY_REGS, default=False): cv.boolean,
    }
...
async def register_ade7953(var, config):
    ...
    cg.add(var.set_use_acc_energy_regs(config.get(CONF_USE_ACC_ENERGY_REGS)))
