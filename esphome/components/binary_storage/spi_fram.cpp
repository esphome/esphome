...
storage::StorageError SPIFram::read_physical(uint64_t offset, uint8_t *buf, size_t len, size_t *bytes_transferred) {
...
storage::StorageError SPIFram::erase_physical(uint64_t offset, size_t len) {
