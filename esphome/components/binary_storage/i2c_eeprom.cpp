...
storage::StorageError I2CEeprom::read_physical(uint64_t offset, uint8_t *buf, size_t len, size_t *bytes_transferred) {
...
storage::StorageError I2CEeprom::write_physical(uint64_t offset, const uint8_t *buf, size_t len,
