...
from esphome.const import CONF_ID, CONF_HUMIDITY, CONF_TEMPERATURE, CONF_LIGHT, CONF_NOISE_LEVEL, CONF_PM_10_0, \
    CONF_UPDATE_INTERVAL, UNIT_PERCENT, UNIT_CELSIUS, ICON_WATER_PERCENT, ICON_THERMOMETER, ICON_LIGHTBULB, \
    ICON_PULSE, ICON_CHEMICAL_WEAPON
