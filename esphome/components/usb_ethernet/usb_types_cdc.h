...
typedef struct {
  ...
  union {
    struct {
      ...
      uint8_t serial : 1;   // Device supports Set/Get_Line_Coding, Set_Control_Line_State and Serial_State request and
                            // notifications
...
typedef union {
  struct {
    uint16_t bRxCarrier : 1;   // State of receiver carrier detection mechanism of device. This signal corresponds to
                               // V.24 signal 109 and RS-232 signal DCD.
    uint16_t bTxCarrier : 1;   // State of transmission carrier. This signal corresponds to V.24 signal 106 and RS-232
                               // signal DSR.
