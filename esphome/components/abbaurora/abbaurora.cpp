    ...
    if(now - last_request > 1000){
        ...
        {  
            ...
            case 4: if(identification_ && this->read_system_serialnumber_())
                    ...
                    break;
            case 6: if(inverter_version_ && this->read_version_())
...
bool ABBAuroraComponent::read_timedate_(){
    ...
    timedate_.Seconds = ((uint32_t)receive_data_[2] << 24) + ((uint32_t)receive_data_[3] << 16) + ((uint32_t)receive_data_[4] << 8) + (uint32_t)receive_data_[5];
    return timedate_.ReadState;
}

bool ABBAuroraComponent::read_last_four_alarms_(){
    last_four_alarms_.ReadState = send_(this->address_, (uint8_t)86, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);

    if (last_four_alarms_.ReadState == false){
        receive_data_[0] = 255;
        receive_data_[1] = 255;
        receive_data_[2] = 255;
        receive_data_[3] = 255;
...
bool ABBAuroraComponent::read_junctionbox_state_(uint8_t nj){
    ...
    junctionbox_state_.jBoxstate_.unbalancedStringCurrent = receive_data_[1] & 0x08;
...
bool ABBAuroraComponent::read_system_partnumber_(){
    system_partnumber_.ReadState = send_(this->address_, (uint8_t)52, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);
...
bool ABBAuroraComponent::read_system_serialnumber_(){
    system_serialnumber_.ReadState = send_(this->address_, (uint8_t)63, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);
...
bool ABBAuroraComponent::read_manufacturing_week_year_(){
    manufacturing_week_year_.ReadState = send_(this->address_, (uint8_t)65, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);

    if (manufacturing_week_year_.ReadState == false){
        receive_data_[0] = 255;
        receive_data_[1] = 255;
    }
...
bool ABBAuroraComponent::read_firmware_release_(){
    firmware_release_.ReadState = send_(this->address_, (uint8_t)72, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);

    if (firmware_release_.ReadState == false){
        receive_data_[0] = 255;
        receive_data_[1] = 255;
    }
...
bool ABBAuroraComponent::read_cumulated_energy_(CumulatedEnergyType par){
    if ((int)par >= 0 && (int)par <= 6){
        cumulated_energy_.ReadState = send_(this->address_, (uint8_t)78, par, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0, (uint8_t)0);

        if (cumulated_energy_.ReadState == false)
        {
            receive_data_[0] = 255;
            receive_data_[1] = 255;
        }
