...
void DS3231Component::read_time() {
  ...
  if (!rtc_time.is_valid()) {
    ESP_LOGE(TAG, "Invalid RTC time: %04d-%02d-%02d %02d:%02d:%02d", rtc_time.year, rtc_time.month,
             rtc_time.day_of_month, rtc_time.hour, rtc_time.minute, rtc_time.second);
    return;
  }
  ...
  ESP_LOGD(TAG, "RTC time: %04d-%02d-%02d %02d:%02d:%02d (DOW: %d)", rtc_time.year, rtc_time.month,
...
void DS3231Component::write_time() {
  ...
  ESP_LOGD(TAG, "Time written to RTC: %04d-%02d-%02d %02d:%02d:%02d (DOW: %d)", now.year, now.month, now.day_of_month,
...
bool DS3231Component::read_rtc_() {
  ...
  ESP_LOGD(TAG,
           ...
           "Ctrl: %02X Status: %02X "
           "Temp: %d.%02d°C",
           ds3231_.reg.hours_10, ds3231_.reg.hours, ds3231_.reg.minutes_10, ds3231_.reg.minutes, ds3231_.reg.seconds_10,
           ds3231_.reg.seconds, ds3231_.reg.day_10, ds3231_.reg.day, ds3231_.reg.month_10, ds3231_.reg.month,
           ds3231_.reg.year_10, ds3231_.reg.year, ds3231_.reg.day_of_week, *(uint8_t *) &ds3231_.reg.control,
           *(uint8_t *) &ds3231_.reg.status, (int8_t) ds3231_.reg.temp_msb, ((ds3231_.reg.temp_lsb >> 6) * 25));
...
bool DS3231Component::write_rtc_() {
  ...
  uint8_t control_reg = (ds3231_.reg.rs & 0x03) | (ds3231_.reg.intcn ? 0x04 : 0x00) | (ds3231_.reg.a2ie ? 0x02 : 0x00) |
  ...
  uint8_t status_reg = (ds3231_.reg.en32khz ? 0x08 : 0x00) | (ds3231_.reg.bsy ? 0x04 : 0x00) |
                       (ds3231_.reg.a2f ? 0x02 : 0x00) | (ds3231_.reg.a1f ? 0x01 : 0x00) |
