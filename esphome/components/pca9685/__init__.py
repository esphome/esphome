...
from esphome.const import CONF_FREQUENCY, CONF_ID, CONF_EXTCLKIN
    ...
    cv.Schema(
        {
            ...
            cv.Optional(CONF_EXTCLKIN, default=False): cv.boolean,
        }
    )
...
async def to_code(config):
    ...
    cg.add(var.set_extclk(config[CONF_EXTCLKIN]))
