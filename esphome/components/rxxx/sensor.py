...
from esphome.const import CONF_CAPACITY, CONF_FINGERPRINT_COUNT, CONF_LAST_CONFIDENCE, \
    CONF_LAST_FINGER_ID, CONF_SECURITY_LEVEL, CONF_STATUS, ICON_ACCOUNT, ICON_ACCOUNT_CHECK, \
    ICON_DATABASE, ICON_EMPTY, ICON_FINGERPRINT, ICON_SECURITY, UNIT_EMPTY
