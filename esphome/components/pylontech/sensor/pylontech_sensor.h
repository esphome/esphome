...
class PylontechSensor : public PylontechListener {
 public:
  ...
  void set_temperature_low_sensor(sensor::Sensor *temperature_low_sensor) { temperature_low_sensor_ = temperature_low_sensor; }
  void set_temperature_high_sensor(sensor::Sensor *temperature_high_sensor) { temperature_high_sensor_ = temperature_high_sensor; }
  ...
  void set_mos_temperature_sensor(sensor::Sensor *mos_temperature_sensor) { mos_temperature_sensor_ = mos_temperature_sensor; }
