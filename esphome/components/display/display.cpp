...
void Display::lineAtAngle(int x, int y, int angle, int length, Color color) {
  this->lineAtAngle(x, y, angle, 0, length, color);
}

void Display::lineAtAngle(int x, int y, int angle, int startRadius, int stopRadius, Color color) {
