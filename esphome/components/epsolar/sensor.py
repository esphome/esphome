...
from .const import (
    CONF_ARRAY_RATED_VOLTAGE,
    CONF_ARRAY_RATED_CURRENT,
    CONF_ARRAY_RATED_POWER,
    CONF_BATTERY_RATED_VOLTAGE,
    CONF_BATTERY_RATED_CURRENT,
    CONF_BATTERY_RATED_POWER,
    CONF_CHARGING_MODE,
    CONF_RATED_CURRENT_OF_LOAD,
    CONF_PV_INPUT_VOLTAGE,
    CONF_PV_INPUT_CURRENT,
    CONF_PV_POWER,
    CONF_BATTERY_POWER,
    CONF_LOAD_VOLTAGE,
    CONF_LOAD_CURRENT,
    ...
    CONF_BATTERY_SOC,
    CONF_REMOTE_BATTERY_TEMPERATURE,
    CONF_BATTERY_STATUS,
    CONF_CHARGING_STATUS,
    CONF_DISCHARGING_STATUS,
    CONF_MAX_PV_VOLTAGE_TODAY,
    CONF_MIN_PV_VOLTAGE_TODAY,
    CONF_MAX_BATTERY_VOLTAGE_TODAY,
    CONF_MIN_BATTERY_TODAY,
    CONF_CONSUMED_ENERGY_TODAY,
    CONF_CONSUMED_ENERGY_MONTH,
    CONF_CONSUMED_ENERGY_YEAR,
    CONF_CONSUMED_ENERGY_TOTAL,
    CONF_GENERATED_ENERGY_TODAY,
    CONF_GENERATED_ENERGY_MONTH,
    CONF_GENERATED_ENERGY_YEAR,
    CONF_GENERATED_ENERGY_TOTAL,
    CONF_BATTERY_CURRENT,
    CONF_BATTERY_TYPE,
    CONF_BATTERY_CAPACITY,
    CONF_CO2_REDUCTION,
    CONF_HIGH_VOLT_DISCONNECT,
    CONF_TEMPERATURE_COMPENSATION_COEFFICIENT,
    CONF_CHARGING_LIMIT_VOLTAGE,
    CONF_OVER_VOLTAGE_RECONNECT,
    CONF_EQUALIZATION_VOLTAGE,
    CONF_BOOST_VOLTAGE,
    CONF_FLOAT_VOLTAGE,
    CONF_BOOST_RECONNECT_VOLTAGE,
    CONF_LOW_VOLTAGE_RECONNECT,
    CONF_UNDER_VOLTAGE_RECOVER,
    CONF_UNDER_VOLTAGE_WARNING,
    CONF_LOW_VOLTAGE_DISCONNECT,
    CONF_SYNC_RTC,
    CONF_DISCHARGING_LIMIT_VOLTAGE,
    CONF_BATTERY_RESISTENCE_ERROR,
    CONF_EQUALIZATION_CHARGING_CYCLE,
    CONF_BATTERY_TEMPERATURE_WARNING_UPPER_LIMIT,
    CONF_BATTERY_TEMPERATURE_WARNING_LOWER_LIMIT,
    ...
    CONF_LINE_IMPEDANCE,
    CONF_DAY_TIME_THRESHOLD_VOLTAGE,
    CONF_LIGHT_SIGNAL_STARTUP_DELAY_TIME,
    CONF_NIGHT_TIMETHRESHOLD_VOLTAGE,
    CONF_LIGHT_SIGNAL_TURN_OFF_DELAY_TIME,
    CONF_DEVICE_OVERTEMPERATURE,
    CONF_IS_NIGHT,
    CONF_MANUAL_CONTROL_LOAD,
    CONF_ENABLE_LOAD_TEST_MODE,
    CONF_FORCE_LOAD_ON,
    CONF_LOAD_CONTROL_MODE,
    CONF_WORKING_TIME_LENGTH_1,
    CONF_WORKING_TIME_LENGTH_2,
    CONF_TURN_ON_TIMING_1_SEC,
    CONF_TURN_ON_TIMING_1_MIN,
    CONF_TURN_ON_TIMING_1_HOUR,
    CONF_TURN_ON_TIMING_2_SEC,
    CONF_TURN_ON_TIMING_2_MIN,
    CONF_TURN_ON_TIMING_2_HOUR,
    CONF_TURN_OFF_TIMING_1_SEC,
    CONF_TURN_OFF_TIMING_1_MIN,
    CONF_TURN_OFF_TIMING_1_HOUR,
    CONF_TURN_OFF_TIMING_2_SEC,
    CONF_TURN_OFF_TIMING_2_MIN,
    CONF_TURN_OFF_TIMING_2_HOUR,
    CONF_BACKLIGHT_TIME,
    CONF_LENGTH_OF_NIGHT,
    CONF_MAIN_POWER_SUPPLY,
    CONF_BATTERY_RATED_VOLTAGE_CODE,
    CONF_DEFAULT_LOAD_MODE,
    CONF_EQUALIZE_DURATION,
    CONF_BOOST_DURATION,
    CONF_DISCHARGE_PERCENTAGE,
    CONF_CHARGING_PERCENTAGE,
    ...
    MODBUS_CONFIG_SCHEMA.extend(
        {
            ...
            cv.Optional(CONF_ARRAY_RATED_VOLTAGE): modbus_sensor_schema(
            ...
            cv.Optional(CONF_ARRAY_RATED_CURRENT): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_ARRAY_RATED_POWER): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x2,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_RATED_VOLTAGE): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x4,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_RATED_CURRENT): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x5,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_RATED_POWER): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x6,
                ALLBITS,
            ...
            cv.Optional(CONF_CHARGING_MODE): modbus_sensor_schema(
                "read_input_registers",
                0x3000,
                0x8,
                ALLBITS,
            ...
            cv.Optional(CONF_RATED_CURRENT_OF_LOAD): modbus_sensor_schema(
                "read_input_registers",
                0x300E,
                0x0,
                ALLBITS,
            ...
            cv.Optional(CONF_PV_INPUT_VOLTAGE): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x0,
                ALLBITS,
            ...
            cv.Optional(CONF_PV_INPUT_CURRENT): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_PV_POWER): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x2,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_POWER): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x6,
                ALLBITS,
            ...
            cv.Optional(CONF_LOAD_VOLTAGE): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0xC,
                ALLBITS,
            ...
            cv.Optional(CONF_LOAD_CURRENT): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0xD,
                ALLBITS,
            ...
            cv.Optional(CONF_LOAD_POWER): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0xE,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_TEMPERATURE): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x10,
                ALLBITS,
            ...
            cv.Optional(CONF_DEVICE_TEMPERATURE): modbus_sensor_schema(
                "read_input_registers",
                0x3100,
                0x11,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_SOC): modbus_sensor_schema(
                "read_input_registers",
                0x311A,
                0x0,
                ALLBITS,
            ...
            cv.Optional(CONF_REMOTE_BATTERY_TEMPERATURE): modbus_sensor_schema(
                "read_input_registers",
                0x311A,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_STATUS): modbus_sensor_schema(
                "read_input_registers",
                0x3200,
                0x0,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_RESISTENCE_ERROR): modbus_binarysensor_schema(
                "read_input_registers", 0x3200, 0x0, 256
            ),
            cv.Optional(CONF_CHARGING_STATUS): modbus_sensor_schema(
                "read_input_registers",
                0x3200,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_DISCHARGING_STATUS): modbus_sensor_schema(
                "read_input_registers",
                0x3200,
                0x2,
                ALLBITS,
            ...
            cv.Optional(CONF_MAX_PV_VOLTAGE_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x0,
                ALLBITS,
            ...
            cv.Optional(CONF_MIN_PV_VOLTAGE_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_MAX_BATTERY_VOLTAGE_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x2,
                ALLBITS,
            ...
            cv.Optional(CONF_MIN_BATTERY_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x3,
                ALLBITS,
            ...
            cv.Optional(CONF_CONSUMED_ENERGY_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x4,
                ALLBITS,
            ...
            cv.Optional(CONF_CONSUMED_ENERGY_MONTH): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x6,
                ALLBITS,
            ...
            cv.Optional(CONF_CONSUMED_ENERGY_YEAR): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x8,
                ALLBITS,
            ...
            cv.Optional(CONF_CONSUMED_ENERGY_TOTAL): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0xA,
                ALLBITS,
            ...
            cv.Optional(CONF_GENERATED_ENERGY_TODAY): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0xC,
                ALLBITS,
            ...
            cv.Optional(CONF_GENERATED_ENERGY_MONTH): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0xE,
                ALLBITS,
            ...
            cv.Optional(CONF_GENERATED_ENERGY_YEAR): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x10,
                ALLBITS,
            ...
            cv.Optional(CONF_GENERATED_ENERGY_TOTAL): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x12,
                ALLBITS,
            ...
            cv.Optional(CONF_CO2_REDUCTION): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x14,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_VOLTAGE): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x1A,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_CURRENT): modbus_sensor_schema(
                "read_input_registers",
                0x3300,
                0x1B,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_TYPE): modbus_sensor_schema(
            ...
            cv.Optional(CONF_BATTERY_CAPACITY): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x1,
                ALLBITS,
            ...
            cv.Optional(CONF_HIGH_VOLT_DISCONNECT): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x3,
                ALLBITS,
            ...
            cv.Optional(CONF_CHARGING_LIMIT_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x4,
                ALLBITS,
            ...
            cv.Optional(CONF_OVER_VOLTAGE_RECONNECT): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x5,
                ALLBITS,
            ...
            cv.Optional(CONF_EQUALIZATION_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x6,
                ALLBITS,
            ...
            cv.Optional(CONF_BOOST_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x7,
                ALLBITS,
            ...
            cv.Optional(CONF_FLOAT_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x8,
                ALLBITS,
            ...
            cv.Optional(CONF_BOOST_RECONNECT_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0x9,
                ALLBITS,
            ...
            cv.Optional(CONF_LOW_VOLTAGE_RECONNECT): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0xA,
                ALLBITS,
            ...
            cv.Optional(CONF_UNDER_VOLTAGE_RECOVER): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0xB,
                ALLBITS,
            ...
            cv.Optional(CONF_UNDER_VOLTAGE_WARNING): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0xC,
                ALLBITS,
            ...
            cv.Optional(CONF_LOW_VOLTAGE_DISCONNECT): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0xD,
                ALLBITS,
            ...
            cv.Optional(CONF_DISCHARGING_LIMIT_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9000,
                0xE,
                ALLBITS,
            ...
            cv.Optional(CONF_EQUALIZATION_CHARGING_CYCLE): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0x03,
                ALLBITS,
            ...
            cv.Optional(CONF_LINE_IMPEDANCE): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0xA,
                ALLBITS,
            ...
            cv.Optional(CONF_DAY_TIME_THRESHOLD_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0x0B,
                ALLBITS,
            ...
            cv.Optional(CONF_LIGHT_SIGNAL_STARTUP_DELAY_TIME): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0x0C,
                ALLBITS,
            ...
            cv.Optional(CONF_NIGHT_TIMETHRESHOLD_VOLTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0x0D,
                ALLBITS,
            ...
            cv.Optional(CONF_LIGHT_SIGNAL_TURN_OFF_DELAY_TIME): modbus_sensor_schema(
                "read_holding_registers",
                0x9013,
                0x0E,
                ALLBITS,
            ...
            cv.Optional(CONF_LOAD_CONTROL_MODE): modbus_sensor_schema(
                "read_holding_registers",
                0x903D,
                0x00,
                ALLBITS,
            ...
            cv.Optional(CONF_WORKING_TIME_LENGTH_1): modbus_sensor_schema(
                "read_holding_registers",
                0x903D,
                0x01,
                ALLBITS,
            ...
            cv.Optional(CONF_WORKING_TIME_LENGTH_2): modbus_sensor_schema(
                "read_holding_registers",
                0x903D,
                0x02,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_1_SEC): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x00,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_1_MIN): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x01,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_1_HOUR): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x02,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_OFF_TIMING_1_SEC): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x03,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_OFF_TIMING_1_MIN): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x04,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_OFF_TIMING_1_HOUR): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x05,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_2_SEC): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x06,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_2_MIN): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x07,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_ON_TIMING_2_HOUR): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x08,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_OFF_TIMING_2_SEC): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x09,
                ALLBITS,
            ...
            cv.Optional(CONF_TURN_OFF_TIMING_2_HOUR): modbus_sensor_schema(
                "read_holding_registers",
                0x9042,
                0x0B,
                ALLBITS,
            ...
            cv.Optional(CONF_BACKLIGHT_TIME): modbus_sensor_schema(
                "read_holding_registers",
                0x9063,
                0x00,
                ALLBITS,
            ...
            cv.Optional(CONF_LENGTH_OF_NIGHT): modbus_sensor_schema(
                "read_holding_registers",
                0x9063,
                0x02,
                ALLBITS,
            ...
            cv.Optional(CONF_MAIN_POWER_SUPPLY): modbus_sensor_schema(
                "read_holding_registers",
                0x9063,
                0x03,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_RATED_VOLTAGE_CODE): modbus_sensor_schema(
                "read_holding_registers",
                0x9063,
                0x04,
                ALLBITS,
            ...
            cv.Optional(CONF_DEFAULT_LOAD_MODE): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x00,
                ALLBITS,
            ...
            cv.Optional(CONF_EQUALIZE_DURATION): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x01,
                ALLBITS,
            ...
            cv.Optional(CONF_BOOST_DURATION): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x02,
                ALLBITS,
            ...
            cv.Optional(CONF_DISCHARGE_PERCENTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x03,
                ALLBITS,
            ...
            cv.Optional(CONF_CHARGING_PERCENTAGE): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x04,
                ALLBITS,
            ...
            cv.Optional(CONF_BATTERY_MANAGEMENT_MODE): modbus_sensor_schema(
                "read_holding_registers",
                0x906A,
                0x05,
                ALLBITS,
            ...
            cv.Optional(CONF_DEVICE_OVERTEMPERATURE): modbus_binarysensor_schema(
                "read_discrete_inputs", 0x2000, 0x0, 0x1
            ),
            cv.Optional(CONF_IS_NIGHT): modbus_binarysensor_schema(
                "read_discrete_inputs", 0x200C, 0x0, 0x1
            ),
            cv.Optional(CONF_MANUAL_CONTROL_LOAD): modbus_binarysensor_schema(
                "read_coils", 0x2, 0x0, 0b0001
            ),
            cv.Optional(CONF_ENABLE_LOAD_TEST_MODE): modbus_binarysensor_schema(
                "read_coils", 0x2, 0x0, 0b0100
            ),
            cv.Optional(CONF_FORCE_LOAD_ON): modbus_binarysensor_schema(
                "read_coils", 0x2, 0x0, 0b1000
            ),
...
def to_code(config):
    ...
    if CONF_ARRAY_RATED_VOLTAGE in config:
        ...
        cg.add(
            var.add_sensor(
                sens,
                conf[CONF_MODBUS_FUNCTIONCODE],
                conf[CONF_ADDRESS],
                conf[CONF_OFFSET],
                conf[CONF_BITMASK],
                conf[CONF_VALUE_TYPE],
