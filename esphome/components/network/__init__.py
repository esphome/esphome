...
async def to_code(config):
    ...
    if CORE.is_nrf52:
        ...
        # (select MBEDTLS_MAC_MD5_ENABLED does not bring in the legacy C API here). Fall back to the
        # non-cryptographic sys_rand ISN; this is an IPv6/OpenThread device where TCP-over-IPv4 ISN
