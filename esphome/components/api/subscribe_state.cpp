...
#endif
#ifdef USE_COVER
  add_on_entity_callback([this](cover::Cover *cover) { return this->client_->send_cover_state(cover); });
#endif
#ifdef USE_FAN
  add_on_entity_callback([this](fan::Fan *fan) { return this->client_->send_fan_state(fan); });
#endif
#ifdef USE_LIGHT
  add_on_entity_callback([this](light::LightState *light) { return this->client_->send_light_state(light); });
#endif
#ifdef USE_SENSOR
...
#endif
#ifdef USE_CLIMATE
  add_on_entity_callback([this](climate::Climate *climate) { return this->client_->send_climate_state(climate); });
#endif
#ifdef USE_NUMBER
  add_on_entity_callback(
...
#endif
#ifdef USE_LOCK
  add_on_entity_callback([this](lock::Lock *a_lock) { return this->client_->send_lock_state(a_lock, a_lock->state); });
#endif
