...
class ProtoWriteBuffer {
 public:
  ...
  void encode_sub_message_(uint32_t field_id, const void *value, void (*encode_fn)(const void *, ProtoWriteBuffer &));
  // Non-template core for encode_optional_sub_message.
  void encode_optional_sub_message_(uint32_t field_id, uint32_t nested_size, const void *value,
...
template<typename T> inline void ProtoWriteBuffer::encode_sub_message(uint32_t field_id, const T &value) {
  this->encode_sub_message_(field_id, &value, &proto_encode_msg<T>);
}
...
template<typename T> inline void ProtoWriteBuffer::encode_optional_sub_message(uint32_t field_id, const T &value) {
  this->encode_optional_sub_message_(field_id, value.calculate_size(), &value, &proto_encode_msg<T>);
}
