...
class APIConnection final : public APIServerConnection {
 ...
 protected:
  ...
  bool send_hello_response(const HelloRequest &msg);
  bool send_disconnect_response();
  bool send_ping_response();
  bool send_device_info_response();
#ifdef USE_API_NOISE
  bool send_noise_encryption_set_key_response(const NoiseEncryptionSetKeyRequest &msg);
#endif
#ifdef USE_BLUETOOTH_PROXY
  bool send_subscribe_bluetooth_connections_free_response();
#endif
#ifdef USE_VOICE_ASSISTANT
  bool send_voice_assistant_get_configuration_response(const VoiceAssistantConfigurationRequest &msg);
#endif
