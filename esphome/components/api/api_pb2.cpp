...
template<>
const char *proto_enum_to_string<LegacyCoverState>(LegacyCoverState value) {
  switch (value) {
    case LEGACY_COVER_STATE_OPEN: return "LEGACY_COVER_STATE_OPEN";
    case LEGACY_COVER_STATE_CLOSED: return "LEGACY_COVER_STATE_CLOSED";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<CoverOperation>(CoverOperation value) {
  switch (value) {
    case COVER_OPERATION_IDLE: return "COVER_OPERATION_IDLE";
    case COVER_OPERATION_IS_OPENING: return "COVER_OPERATION_IS_OPENING";
    case COVER_OPERATION_IS_CLOSING: return "COVER_OPERATION_IS_CLOSING";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<LegacyCoverCommand>(LegacyCoverCommand value) {
  switch (value) {
    case LEGACY_COVER_COMMAND_OPEN: return "LEGACY_COVER_COMMAND_OPEN";
    case LEGACY_COVER_COMMAND_CLOSE: return "LEGACY_COVER_COMMAND_CLOSE";
    case LEGACY_COVER_COMMAND_STOP: return "LEGACY_COVER_COMMAND_STOP";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<FanSpeed>(FanSpeed value) {
  switch (value) {
    case FAN_SPEED_LOW: return "FAN_SPEED_LOW";
    case FAN_SPEED_MEDIUM: return "FAN_SPEED_MEDIUM";
    case FAN_SPEED_HIGH: return "FAN_SPEED_HIGH";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<LogLevel>(LogLevel value) {
  switch (value) {
    ...
    case LOG_LEVEL_VERBOSE: return "LOG_LEVEL_VERBOSE";
    case LOG_LEVEL_VERY_VERBOSE: return "LOG_LEVEL_VERY_VERBOSE";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<ServiceArgType>(ServiceArgType value) {
  switch (value) {
    case SERVICE_ARG_TYPE_BOOL: return "SERVICE_ARG_TYPE_BOOL";
    case SERVICE_ARG_TYPE_INT: return "SERVICE_ARG_TYPE_INT";
    case SERVICE_ARG_TYPE_FLOAT: return "SERVICE_ARG_TYPE_FLOAT";
    case SERVICE_ARG_TYPE_STRING: return "SERVICE_ARG_TYPE_STRING";
    default: return "UNKNOWN";
  }
}
template<>
const char *proto_enum_to_string<ClimateMode>(ClimateMode value) {
  switch (value) {
    case CLIMATE_MODE_OFF: return "CLIMATE_MODE_OFF";
    case CLIMATE_MODE_AUTO: return "CLIMATE_MODE_AUTO";
    case CLIMATE_MODE_COOL: return "CLIMATE_MODE_COOL";
    case CLIMATE_MODE_HEAT: return "CLIMATE_MODE_HEAT";
    default: return "UNKNOWN";
  }
}
...
void SubscribeServiceCallsRequest::dump_to(std::string &out) const {
  out.append("SubscribeServiceCallsRequest {}");
}
