...
WaveshareEPaper::WaveshareEPaper(GPIOPin *dc_pin)
    : PollingComponent(0), dc_pin_(dc_pin) {}
...
WaveshareEPaperTypeA::WaveshareEPaperTypeA(GPIOPin *dc_pin,
                                           WaveshareEPaperTypeAModel model)
...
WaveshareEPaper2P7In::WaveshareEPaper2P7In(GPIOPin *dc_pin)
    : WaveshareEPaper(dc_pin) {}
...
WaveshareEPaper4P2In::WaveshareEPaper4P2In(GPIOPin *dc_pin)
    : WaveshareEPaper(dc_pin) {}
...
WaveshareEPaper7P5In::WaveshareEPaper7P5In(GPIOPin *dc_pin)
    : WaveshareEPaper(dc_pin) {}
