...
void WaveshareEPaper7P5InV2alt::reset_() {
  /*
...
void WaveshareEPaper7P5InV2alt::initialize() {
  ...
  for(count=0; count<60; count++)
    this->data(LUT_VCOM_7IN5_V2[count]);

  this->command(0x21); //LUTBW
  for(count=0; count<60; count++)
    this->data(LUT_WW_7IN5_V2[count]);

  this->command(0x22); //LUTBW
  for(count=0; count<60; count++)
    this->data(LUT_BW_7IN5_V2[count]);

  this->command(0x23); //LUTWB
  for(count=0; count<60; count++)
    this->data(LUT_WB_7IN5_V2[count]);

  this->command(0x24); //LUTBB
  for(count=0; count<60; count++)
    this->data(LUT_BB_7IN5_V2[count]);
}
