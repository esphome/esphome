...
WK2132ComponentSPI = wk2132_ns.class_(
    "WK2132ComponentSPI", wk2168.WK2132Component, spi.SPIDevice
)

CONFIG_SCHEMA = cv.All(
    wk2168.WK2132_SCHEMA.extend(
        {
            cv.GenerateID(): cv.declare_id(WK2132ComponentSPI),
        }
    ).extend(spi.spi_device_schema()),
    wk2168.post_check_conf_wk2132,
)
...
async def to_code(config):
    ...
    await wk2168.register_wk2132(var, config)
