...
LV_DEFINES = (
    ...
    "LV_USE_GRID", "LV_USE_SYSMON", "LV_USE_PERF_MONITOR", "LV_USE_PERF_MONITOR_POS",
    "LV_USE_PERF_MONITOR_LOG_MODE", "LV_USE_PROFILER", "LV_USE_PROFILER_BUILTIN",
    "LV_USE_PROFILER_BUILTIN_POSIX", "LV_PROFILER_INCLUDE", "LV_PROFILER_BEGIN",
    "LV_PROFILER_END", "LV_PROFILER_BEGIN_TAG", "LV_PROFILER_END_TAG",
    "LV_PROFILER_BUILTIN_BUF_SIZE", "LV_PROFILER_BUILTIN_DEFAULT_ENABLE", "LV_PROFILER_LAYOUT",
