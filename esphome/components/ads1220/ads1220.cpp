...
static constexpr uint8_t ADS1220_START{
...
uint8_t ADS1220Component::getGainFactor() { return gain; }
...
/* Other settings */
void ADS1220Component::setVRefValue(float refVal) { vRef = refVal; }

float ADS1220Component::getVRef_V() { return vRef; }
...
float ADS1220Component::getVoltage_muV() { return getVoltage_mV() * 1000.0; }

int32_t ADS1220Component::getRawData() { return getData(); }
...
void ADS1220Component::reset() { send_command(ADS1220_RESET); }

void ADS1220Component::start() { send_command(ADS1220_START); }
...
float ADS1220Sensor::sample() { return this->parent_->request_measurement(this); }
