from esphome.components.mipi import SLPOUT, delay
...
# JC1060P470-V2: 2026 batch of the JC1060P470 with a different 7" panel behind the same JD9165 driver.
# The rear label shows "V2" after the material number. Timings and init sequence taken from Guition's
# reference driver JC1060P470C_I_W_Y.zip (2026-07-13),
# 1-Demo/.../JC1060P470C_I_W_Y_New_Panel/lvgl_demo_v8/src/lcd/esp_lcd_jd9165.{c,h}
# ----------------------------------------------------------------------------------------------------------------------
# * Resolution: 1024x600
# * PCLK Frequency: 52 MHz
# * DSI Lane Bit Rate: 750 Mbps (using 2-Lane DSI configuration)
# * Horizontal Timing (hsync_pulse_width=24, hsync_back_porch=136, hsync_front_porch=160)
# * Vertical Timing (vsync_pulse_width=2, vsync_back_porch=21, vsync_front_porch=12)
# ----------------------------------------------------------------------------------------------------------------------
DsiDriverChip(
    "JC1060P470-V2",
    width=1024,
    ...
    initsequence=[
        ...
        (0x20, 0x04), (0x1F, 0x05), (0x23, 0x38), (0x28, 0x18), (0x29, 0x29), (0x2A, 0x01), (0x2B, 0x29),
        (0x2C, 0x01), (0x30, 0x02), (0x00, 0x05), (0x01, 0x22), (0x02, 0x08), (0x03, 0x12), (0x04, 0x16),
        (0x05, 0x64), (0x06, 0x00), (0x07, 0x00), (0x08, 0x78), (0x09, 0x00), (0x0A, 0x04),
        ...
        (0x13, 0x00, 0x00, 0x00, 0x00), (0x14, 0x00, 0x00, 0x41, 0x41), (0x15, 0x00, 0x00, 0x00, 0x00),
        (0x17, 0x00), (0x18, 0x85), (0x19, 0x06, 0x09), (0x1A, 0x05, 0x08), (0x1B, 0x0A, 0x04), (0x26, 0x00),
        (0x27, 0x00), (0x30, 0x06),
        ...
        (0x30, 0x0A), (0x02, 0x4F), (0x0B, 0x40), (0x30, 0x0D), (0x0D, 0x04), (0x10, 0x05), (0x11, 0x0C),
        (0x12, 0x05), (0x13, 0x0C), (0x30, 0x00),
        (SLPOUT,), delay(120),
    ],
)
