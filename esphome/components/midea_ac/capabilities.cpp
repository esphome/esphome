...
#define DEVICE_STRUCT(name) { LIST_##name, NAME_##name, FUNC_##name }
...
static const DeviceData DEVICES_DATABASE[] PROGMEM = {
  DEVICE_STRUCT(QA100),     // 0
  DEVICE_STRUCT(SA100),     // 1
  DEVICE_STRUCT(SA200),     // 2
  DEVICE_STRUCT(SA300),     // 3
  DEVICE_STRUCT(YA),        // 4
  DEVICE_STRUCT(26YA),      // 5
  DEVICE_STRUCT(YAB3),      // 6
  DEVICE_STRUCT(WJABC),     // 7
  DEVICE_STRUCT(YA100),     // 8
  DEVICE_STRUCT(CJ200),     // 9
  DEVICE_STRUCT(WYA),       // 10
  DEVICE_STRUCT(WPA),       // 11
  DEVICE_STRUCT(LBB2),      // 12
  DEVICE_STRUCT(LBB3),      // 13
  DEVICE_STRUCT(PA400),     // 14
  DEVICE_STRUCT(WEA),       // 15
  DEVICE_STRUCT(CA),        // 16
  DEVICE_STRUCT(TAB3),      // 17
  DEVICE_STRUCT(TAB12),     // 18
  DEVICE_STRUCT(KHB1),      // 19
  DEVICE_STRUCT(CACP),      // 20
  DEVICE_STRUCT(ZA300),     // 21
  DEVICE_STRUCT(ZA300B3),   // 22
  DEVICE_STRUCT(ZB300),     // 23
  DEVICE_STRUCT(ZB300YJ),   // 24
  DEVICE_STRUCT(YA300),     // 25
  DEVICE_STRUCT(YA201),     // 26
  DEVICE_STRUCT(YA200),     // 27
  DEVICE_STRUCT(YA301),     // 28
  DEVICE_STRUCT(YA302),     // 29
  DEVICE_STRUCT(PC400B23),  // 30
  DEVICE_STRUCT(WXA),       // 31
  DEVICE_STRUCT(WJ7),       // 32
  DEVICE_STRUCT(WYB),       // 33
  DEVICE_STRUCT(PCB50),     // 34
  DEVICE_STRUCT(YB200),     // 35
  DEVICE_STRUCT(DA100),     // 36
  DEVICE_STRUCT(YB200TEST), // 37
  DEVICE_STRUCT(WXD),       // 38
  DEVICE_STRUCT(YB300),     // 39
  DEVICE_STRUCT(WDAA3),     // 40
  DEVICE_STRUCT(WDAD3),     // 41
  DEVICE_STRUCT(WYAD2D3),   // 42
  DEVICE_STRUCT(WPAD3),     // 43
  DEVICE_STRUCT(DA400B3),   // 44
  DEVICE_STRUCT(PC400B1),   // 45
  DEVICE_STRUCT(DA200300),  // 46
  DEVICE_STRUCT(DA400D3),   // 47
  DEVICE_STRUCT(DA400BP),   // 48
  DEVICE_STRUCT(DA400DP),   // 49
  DEVICE_STRUCT(PA400B3),   // 50
  DEVICE_STRUCT(J9),        // 51
  DEVICE_STRUCT(YA400D2D3), // 52
  DEVICE_STRUCT(QA301B1),   // 53
  DEVICE_STRUCT(WCBA3),     // 54
  DEVICE_STRUCT(IQ100),     // 55
  DEVICE_STRUCT(DA100Z),    // 56
  DEVICE_STRUCT(IQ300),     // 57
  DEVICE_STRUCT(J7),        // 58
  DEVICE_STRUCT(WPBC),      // 59
  DEVICE_STRUCT(WPCD),      // 60
  DEVICE_STRUCT(YB400),     // 61
  DEVICE_STRUCT(PE400B3),   // 62
  DEVICE_STRUCT(J8),        // 63
  DEVICE_STRUCT(YA400B2),   // 64
  DEVICE_STRUCT(YB301),     // 65
  DEVICE_STRUCT(WYS),       // 66
  DEVICE_STRUCT(1TO1),      // 67
  DEVICE_STRUCT(1TON),      // 68
  DEVICE_STRUCT(YB201),     // 69
  DEVICE_STRUCT(PF200),     // 70
  DEVICE_STRUCT(GM100),     // 71
  DEVICE_STRUCT(WOW),       // 72
  DEVICE_STRUCT(S10),       // 73
  DEVICE_STRUCT(FA100),     // 74
  DEVICE_STRUCT(FA200),     // 75
  DEVICE_STRUCT(W10),       // 76
  DEVICE_STRUCT(WXDF),      // 77
  DEVICE_STRUCT(YB100),     // 78
  DEVICE_STRUCT(MQ200),     // 79
  DEVICE_STRUCT(GW10),      // 80
};
