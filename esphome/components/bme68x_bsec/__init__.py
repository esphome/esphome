...
# TODO: move CONF_TEMPERATURE_OFFSET to global consts
...
CONF_IAQ_ACCURACY = "iaq_accuracy"  # TODO: move to global consts
...
async def to_code(config):
    ...
    cg.add_library(
        ...
        None,
        "https://github.com/boschsensortec/Bosch-BSEC2-Library.git#v1.6.2400",
    )
