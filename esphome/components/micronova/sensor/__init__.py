...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_ROOM_TEMPERATURE): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x01, is_polling_component=True
            )
        ),
        cv.Optional(CONF_FUMES_TEMPERATURE): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x5A, is_polling_component=True
            )
        ),
        cv.Optional(CONF_STOVE_POWER): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x34, is_polling_component=True
            )
        ),
        ...
        .extend(
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x37, is_polling_component=True
            )
        )
        .extend(
        ...
        cv.Optional(CONF_WATER_TEMPERATURE): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x3B, is_polling_component=True
            )
        ),
        cv.Optional(CONF_WATER_PRESSURE): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x3C, is_polling_component=True
            )
        ),
        cv.Optional(CONF_MEMORY_ADDRESS_SENSOR): sensor.sensor_schema(
            ...
            MICRONOVA_ADDRESS_SCHEMA(
                default_memory_location=0x00, default_memory_address=0x00, is_polling_component=True
            )
        ),
    }
)
