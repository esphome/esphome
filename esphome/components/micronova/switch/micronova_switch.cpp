    ...
    case MicroNovaFunctions::STOVE_FUNCTION_SWITCH:
      if (state) {
        ...
        if (this->micronova_->get_current_stove_state() == 0) {
          this->micronova_->write_address(this->memory_data_on_, this->memory_address_, this->memory_data_on_);
        ...
        if (this->micronova_->get_current_stove_state() != 0 && micronova_->get_current_stove_state() != 6) {
          this->micronova_->write_address(this->memory_data_on_, this->memory_address_, this->memory_data_off_);
