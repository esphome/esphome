...
from esphome.components.modbus_controller.sensor import SENSOR_VALUE_TYPE
from esphome.const import CONF_ID, CONF_LAMBDA, CONF_MULTIPLY, CONF_ADDRESS, CONF_OFFSET
