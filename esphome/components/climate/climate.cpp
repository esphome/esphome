...
void ClimateCall::validate_() {
  ...
  if (this->target_temperature_.has_value()) {
    ...
    if (traits.get_supports_two_point_target_temperature() ||
        traits.has_feature_flags(CLIMATE_SUPPORTS_TWO_POINT_TARGET_TEMPERATURE |
...
#undef TEMP_IGNORE_MEMACCESS
  ...
  if (traits.get_supports_target_humidity() || traits.has_feature_flags(climate::CLIMATE_SUPPORTS_TARGET_HUMIDITY)) {
...
void Climate::publish_state() {
  ...
  if (traits.get_supports_action() || traits.has_feature_flags(climate::CLIMATE_SUPPORTS_ACTION)) {
  ...
  if (traits.get_supports_current_humidity() || traits.has_feature_flags(climate::CLIMATE_SUPPORTS_CURRENT_HUMIDITY)) {
...
void Climate::dump_traits_(const char *tag) {
  ...
  if (traits.get_supports_target_humidity() || traits.get_supports_current_humidity() ||
      traits.has_feature_flags(climate::CLIMATE_SUPPORTS_TARGET_HUMIDITY |
