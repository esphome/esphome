...
void ClimateTraits::set_supports_boost_mode(bool supports_boost) { supports_boost_ = supports_boost; }
void ClimateTraits::set_supports_sleep_mode(bool supports_sleep) { supports_sleep_ = supports_sleep; }
