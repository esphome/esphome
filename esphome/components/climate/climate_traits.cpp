...
<<<<<<< HEAD
void ClimateTraits::set_supports_turbo(bool supports_turbo) { supports_turbo_ = supports_turbo; }
=======
...
<<<<<<< HEAD
bool ClimateTraits::get_supports_turbo() const { return supports_turbo_; }
=======
