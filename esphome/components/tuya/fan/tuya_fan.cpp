...
void TuyaFan::write_state() {
  ...
  if (this->speed_id_.has_value()) {
    ...
    if (this->fan_->speed == fan::FAN_SPEED_LOW) datapoint.value_enum = 0;
    if (this->fan_->speed == fan::FAN_SPEED_MEDIUM) datapoint.value_enum = 1;
    if (this->fan_->speed == fan::FAN_SPEED_HIGH) datapoint.value_enum = 2;
