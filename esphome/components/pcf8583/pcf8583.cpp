...
static const uint8_t PCF8583_LOCATION_DAY = 0x05;                       //Address Registers maybe needed for future
addition of features static const uint8_t PCF8583_LOCATION_MONTH = 0x06; static const uint8_t PCF8583_LOCATION_YEAR =
0x07;
*/
...
void PCF8583Component::update() { this->update_and_reset(); }
...
void PCF8583Component::set_to_counter_mode() { this->write_byte(PCF8583_LOCATION_CONTROL, PCF8583_MODE_EVENT_COUNTER); }

// converting bcd value to byte
uint8_t PCF8583Component::bcd2byte_(uint8_t value) { return ((value >> 4) * 10) + (value & 0x0f); }

// converting byte value to bcd
uint8_t PCF8583Component::byte2bcd_(uint8_t value) { return ((value / 10) << 4) + (value % 10); }
