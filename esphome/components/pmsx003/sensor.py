...
from esphome.const import CONF_FORMALDEHYDE, CONF_HUMIDITY, CONF_ID, CONF_PM_10_0, \
    CONF_PM_1_0, CONF_PM_2_5, CONF_PMC_1_0, CONF_PMC_2_5, CONF_PMC_10_0, CONF_TEMPERATURE, \
    CONF_TYPE, ICON_CHEMICAL_WEAPON, UNIT_MICROGRAMS_PER_CUBIC_METER, ICON_THERMOMETER, \
