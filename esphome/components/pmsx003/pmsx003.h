...
class PMSX003Component : public uart::UARTDevice, public Component {
 public:
  ...
  void set_pmc_1_0_sensor(sensor::Sensor *pmc_1_0_sensor);
  void set_pmc_2_5_sensor(sensor::Sensor *pmc_2_5_sensor);
  void set_pmc_10_0_sensor(sensor::Sensor *pmc_10_0_sensor);
