...
// Sector parameters are uint32_t by ESP-IDF's ff_diskio_impl_t contract, so this glue layer is
// 32-bit. It stays that way once the follow-up exFAT PR enables FF_FS_EXFAT/FF_LBA64 in a
// patched FatFs copy; without those, LBA_t is the same 32-bit type, so the layer compiles
// identically in both builds. Practical ceiling: 2 TiB at 512-byte sectors, far beyond any
// MSC medium this drives.
