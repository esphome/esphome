...
#if defined(CONFIG_IDF_TARGET_ESP32P4) || defined(CONFIG_ESP_SR_EXTERNAL_MODEL_PATH)
// ESP32-P4 inference and ESP-SR can require vector context to be saved on the
// inference task's stack during a context switch.
