...
class MicroWakeWord : public Component {
 public:
  ...
  bool is_running() const { return this->microphone_source_->is_running() && this->state_ == DETECTING_WAKE_WORD; }
  bool is_stopped() const { return this->microphone_source_->is_stopped(); }
