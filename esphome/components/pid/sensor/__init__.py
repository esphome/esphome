...
PID_CLIMATE_SENSOR_TYPES = {
    ...
    "DEADBAND_TRESHOLD_HIGH": PIDClimateSensorType.PID_SENSOR_TYPE_DEADBAND_TRESHOLD_HIGH,
    "DEADBAND_TRESHOLD_LOW": PIDClimateSensorType.PID_SENSOR_TYPE_DEADBAND_TRESHOLD_LOW,
