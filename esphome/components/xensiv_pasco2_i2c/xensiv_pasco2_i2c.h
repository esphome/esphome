...
#include "esphome/components/xensiv_pasco2_base/xensiv_pasco2_base.h"
#include "esphome/components/i2c/i2c.h"
namespace esphome {
namespace xensiv_pasco2_i2c {

class XensivPasCO2I2CComponent : public esphome::xensiv_pasco2_base::XensivPasCO2, public i2c::I2CDevice {
 public:
 protected:
