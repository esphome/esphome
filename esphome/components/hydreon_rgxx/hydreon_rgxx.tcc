...
void HydreonRGxxComponent<num_sensors_>::dump_config() {
...
template<size_t num_sensors_>
void HydreonRGxxComponent<num_sensors_>::setup() {
...
template<size_t num_sensors_>
bool HydreonRGxxComponent<num_sensors_>::sensor_missing() {
...
template<size_t num_sensors_>
void HydreonRGxxComponent<num_sensors_>::update() {
...
template<size_t num_sensors_>
void HydreonRGxxComponent<num_sensors_>::loop() {
  uint8_t data;
  while (this->available() > 0) {
 ...
 */
template<size_t num_sensors_>
void HydreonRGxxComponent<num_sensors_>::schedule_reboot() {
  this->boot_count_=0;
...
template<size_t num_sensors_>
bool HydreonRGxxComponent<num_sensors_>::buffer_starts_with(const std::string &prefix) {
  return buffer_starts_with(prefix.c_str());
}

template<size_t num_sensors_>
bool HydreonRGxxComponent<num_sensors_>::buffer_starts_with(const char *prefix) {
  return buffer_.rfind(prefix, 0)==0;
}

template<size_t num_sensors_>
void HydreonRGxxComponent<num_sensors_>::process_line() {
...
template<size_t num_sensors_>
float HydreonRGxxComponent<num_sensors_>::get_setup_priority() const { return setup_priority::DATA; }
