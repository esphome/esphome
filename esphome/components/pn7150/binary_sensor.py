...
from . import pn7150_ns, PN7150, CONF_PN7150_ID
...
PN532BinarySensor = pn7150_ns.class_("PN7150BinarySensor", binary_sensor.BinarySensor)

CONFIG_SCHEMA = cv.All(
    binary_sensor.binary_sensor_schema(PN532BinarySensor).extend(
        {
            cv.GenerateID(CONF_PN7150_ID): cv.use_id(PN7150),
