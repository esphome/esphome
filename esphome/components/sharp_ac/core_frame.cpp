...
SharpFrame::~SharpFrame() { delete[] data; }
...
uint8_t *SharpFrame::getData() const { return data; }

size_t SharpFrame::getSize() const { return size; }
...
void SharpFrame::setChecksum() { this->data[size - 1] = calcChecksum(); }

bool SharpFrame::validateChecksum() { return this->data[size - 1] == calcChecksum(); }
...
int SharpStatusFrame::getTemperature() { return this->data[7]; }
