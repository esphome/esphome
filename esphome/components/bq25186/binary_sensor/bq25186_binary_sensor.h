...
using BQ25186SafetyTimerFlagBinarySensor = StatusBinarySensor<BQ25186_REG_STAT1, 2, 0x01, 0x01>;
...
// FLAG0
using BQ25186TsFlagBinarySensor = StatusBinarySensor<BQ25186_REG_FLAG0, 7, 0x01, 0x01>;
