...
class BMP280Component : public PollingComponent {
 ...
 protected:
  virtual bool read_byte_(uint8_t a_register, uint8_t *data) = 0;
  virtual bool write_byte_(uint8_t a_register, uint8_t data) = 0;
  virtual bool read_bytes_(uint8_t a_register, uint8_t *data, size_t len) = 0;
  virtual bool read_byte_16_(uint8_t a_register, uint16_t *data) = 0;
